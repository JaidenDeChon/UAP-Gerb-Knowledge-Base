...
1. **Intelligence**: Satellite and reconnaissance assets (NRO, reconnaissance aircraft) locate and track crash sites
2. **Logistics and Coordination**: CIA (via OGA or predecessor units) facilitates access, coordinates with foreign governments (or bypasses them), and manages operational security
