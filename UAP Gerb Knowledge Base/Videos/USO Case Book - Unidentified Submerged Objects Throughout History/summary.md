...
stats:
  - value: "13,000+"
    label: Blue Book sightings
    hint: Collected by Projects Sign, Grudge and Blue Book, 1949–1969
  - value: 258
    label: Sightings from ships
    hint: 155 in the Pacific and 104 in the Atlantic
  - value: 13
    label: Ship reports up to standard
    hint: Met Blue Book's merit standards; only a handful describe underwater objects
  - value: 104
    label: Years of cases
    hint: The video's cases run from 1873 to 1977
---
::

## Overview

This video is a global historical survey of [[Unidentified Submerged Object (USO)|unidentified submerged object]] sightings, made as a follow-up to UAP Gerb's earlier video [[USO - Unidentified Submerged Objects]]. It argues that credible USO reports span several centuries and the whole world, rather than being a modern American curiosity, and that militaries, merchant navies, scientific institutions and civilians have all recorded them. Gerb works through cases from [[Project Blue Book]], Soviet naval and scientific records, Australian government files and nineteenth-century maritime logs to show that objects with [[Trans-Medium Vehicle|transmedium]] behaviour (leaving and entering the water at speed, hovering just above the surface, submerging without disturbing it) have been reported consistently, whatever the era or nation.

A second thread is how little of this reached the official record. Of the more than 13,000 sightings collected by [[Project Sign]], [[Project Grudge]] and Project Blue Book between 1949 and 1969, only 258 (about 2%) came from ships, only 13 of those met the program's own merit standards for UFO reporting, and only a handful describe USOs. Gerb attributes the gap to the 1952 [[OPNAV 3820]] directive, which restricted Navy UFO reports to three recipients, and to [[JANAP 146c|JANAP 146C]]: "we can thank" the two directives, he says, for how little Blue Book holds.
...
The video is organised by source rather than by date. In date order, its cases fall into two clusters: ships' logs from the steam era and government files from the Cold War, with a gap between the two world wars.

::wiki-timeline{video="Yn-83KbgRN8" video-title="USO Case Book: Unidentified Submerged Objects Throughout History"}
---
help: "The bar above the list runs from 1873 to 1977, with a coloured mark for each case; taller marks are major ones. Click the bar to jump to a year. Its two shaded stretches are the video's two groups of evidence, ships' logs from the nineteenth and early twentieth centuries and government files from the Cold War. The dashed line marks OPNAV 3820, a 1952 Navy directive. The dark line shows which entry you are reading, and Play from here starts the video there. Click a timestamp to play the video from that moment. The video takes its cases by source rather than by date, so once it is playing, the green line that shows its position jumps back and forth."
eras:
  - id: steam
    label: "Logs of the Steam Era"
    from: 1873
    to: 1913
    summary: "Light wheels, fireballs and a sinking cigar, recorded by merchant and naval captains and published by the Admiralty, the US Hydrographic Bureau and the Danish Meteorological Institute."
  - id: coldwar
    label: "The Cold War Files"
    from: 1947
    to: 1977
    summary: "Project Blue Book's ship cases, Soviet naval and scientific reports, and Australia's declassified UFO files."
hinges:
  - year: 1952
    label: "OPNAV 3820"
events:
  - date: "1873-03-27"
    title: "Ship Adhy: a milky light follows the vessel beneath the waves"
    summary: "On a voyage to Singapore, Captain Lebman of the Adhy saw a blinding milky white light appear beneath the waves about two ship-lengths away. It gave off waves of light like snowflakes blown over rocks and followed the ship at four to five knots for about half an hour. The case was reported in The Argus and is held by the National Library of Australia; the video presents it as the earliest light wheel."
    category: event
    significance: major
    cue: 1210
    entities:
  ...
  - date: "1879-05-15"
    title: "HMS Vulture: twin revolving wheels in the Persian Gulf"
    summary: "J. E. Pringle of HMS Vulture reported luminous pulsations in the water passing under the ship at great speed, then two revolving wheels with illuminated spokes about 25 feet long, one to the east and one to the west, turning in equal and opposite directions. The account, reported to the Admiralty by the hydrographer Captain Evans, opens the video's Persian Gulf 'flap' (1879–1901)."
    category: event
    significance: major
    cue: 1261
    entities:
      ...
      - "Maritime Light Wheel"
  - date: "1880-01-05"
    title: "SS Shahian: a milky white circle off the Malabar Coast"
    summary: "On a clear, moonless night around 10 p.m., Commander Harris of the SS Shahian and his third officer saw a milky white circle 'resembling the nebula' with waves of light off the Malabar Coast of India, and stopped the ship to study it. The video calls it a possible light wheel."
    category: event
    ...
    entities:
      ...
      - "Malabar Coast, India"
  - date: "1880-05"
    title: "SS Patna: two enormous luminous wheels"
    summary: "Near 11:30 p.m., the officers and crew of the British India Company steamer Patna saw two enormous luminous wheels whirling on either side of the ship, each some 500 to 600 yards across with about 16 spokes 200 to 300 yards long that seemed to brush along the ship. It was the second of the Persian Gulf encounters."
    category: event
    significance: major
    cue: 1302
    entities:
  ...
  - date: "1901-04-04"
    title: "SS Kila: revolving shafts of light"
    summary: "Aboard the steamship Kila (Kilwa), Captain Hosan's crew saw vast shafts of light appear suddenly on the surface of the sea, one after another, revolving at about 60 mph before dying out over some 15 minutes. It was the last of the Persian Gulf encounters."
    category: event
    significance: notable
    cue: 1351
    entities:
  ...
  - date: "1909-06-10"
    title: "SS Bintang: a vast wheel under the water in the Strait of Malacca"
    summary: "Captain Gabe of the SS Bintang saw a vast revolving wheel of light under the water, with 'long arms issuing from a center,' so large that only half could be seen at once. It moved forward, changed speed and rotation, and vanished when its centre was directly under the ship. The account was published in the Danish Meteorological Institute's nautical-meteorological annual and relayed by Scientific American."
    category: event
    significance: major
    cue: 1410
    entities:
  ...
  - date: "1910"
    title: "Valentin: a horizontal wheel above the South China Sea"
    summary: "Captain Brier (Breyer) of the Dutch steamship Valentin (Valentijn), with his first and second mates and first engineer, saw an object hovering above the water that looked like a rapidly turning horizontal wheel. The video cites it as evidence that light wheels were seen above the water as well as below it."
    category: event
    significance: notable
    cue: 1458
    entities:
  ...
  - date: "1950-08-04"
    ...
    entities:
      ...
      - "Project Blue Book"
  - date: "1952"
    title: "OPNAV 3820 restricts Navy UFO reporting"
    summary: "The Navy directive OPNAV 3820 limited Navy UFO sighting reports to the Air Force Technical Intelligence Center, USAF intelligence and the Director of Naval Intelligence. The video blames it, with JANAP 146C, for how few USO cases reached the official record."
    category: policy
    significance: major
    cue: 28
    entities:
  ...
  - date: "1959-11-07"
    ...
    entities:
      ...
      - "Project Blue Book"
  - date: "1960-06-25"
    title: "Ascension Island: a light under the missile cassette"
    summary: "At 23:34 local time the range vessel code-named Whiskey was recovering the floating data cassette from missile test 1802 when a steady white or yellowish light appeared about 100 yards from the cassette, from under the surface, for 10 seconds, with no waves breaking over it. It was seen by an RCA photographer, a test observer, divers and the recovery plane's pilot and co-pilot. Blue Book called it a flare, though no plane or vessel had released one."
    category: event
    significance: major
    cue: 203
    entities:
      ...
      - "Ascension Island"
  - date: "1963"
    title: "Australian fisherman sees a light shoot up from the water"
    summary: "A 1963 newspaper clipping kept in Australia's government UFO files describes a fisherman watching a light shoot up from the water, hover and disappear; the video cites it as evidence that civilian reports were filed alongside military ones."
    category: document
    significance: minor
    cue: 737
  - date: "1964-01-23"
    title: "Groote Island: the RAAF's first official unusual aerial sighting"
    summary: "The Royal Australian Air Force's first officially logged unusual aerial sighting: a ship's crew off the northeast point of 'Groot Island' saw large lights in the water that made the compass go haywire, with a shadow at their centre rotating clockwise so that the lights pulsed. A report on the magnetic disturbance followed."
    category: event
    significance: major
    cue: 682
  - date: "1966-01-11"
    title: "SS Morgantown Victory: a glowing cigar enters the sea"
    summary: "About 1,000 miles southeast of Tokyo, the third mate, helmsman and bow lookout of the SS Morgantown Victory watched an orange-yellow, cigar-shaped object 200 to 250 feet long approach from the horizon, turn 180 degrees to avoid the ship, hover for 30 seconds, cross the bow, change direction again and enter the sea, three minutes in all. The master thought a plane had crashed and ordered a search. Blue Book attributed it to the decay of the Cosmos 33 satellite."
    category: event
    significance: major
    cue: 278
    entities:
      ...
      - "Project Blue Book"
  - date: "1966"
    title: "Frasier Island: cigars submerge without a ripple"
    summary: "Reported in Flying Saucer Review: private pilot C. Adams and television cameraman Les Hendy saw four or five objects about three miles east of Fraser Island, two dark cigars up to 100 feet long and three smaller objects, standing still in the water. As the aircraft closed to within two miles they submerged. Independent witnesses at a nearby hotel said the surface was not disturbed."
    category: event
    significance: major
    cue: 847
    entities:
  ...
  - date: "1967"
    title: "Department of Works staff see lights leave and re-enter the sea"
    summary: "Australian files record Department of Works staff and local residents watching lights come up out of the sea, climb to a great height, curve and return to the ocean, many with three distinct flashes on re-entry, echoing the City of Alako case. Lieutenant Commander A. F. Perry of Australian intelligence suggested oil-search experiments."
    category: document
    significance: notable
    cue: 754
  - date: "1970-08"
    title: "Kamchatka Lake: an oval rises from a dome of water"
    summary: "According to Russia's USO Secrets and an article by Soviet scientist Valentin Salomshikov, hydrologists in a motorboat on a Kamchatka lake saw a dome of water burst up about a kilometre away and a grey oval object 40 to 60 metres long rise to about 100 metres and hover. Their engine stalled until the object sped away."
    category: event
    significance: major
    cue: 519
    entities:
      ...
      - "Kamchatka Peninsula"
  - date: "1977-06-15"
    title: "Soviet ship Nooget: a sphere rises, circles and dives"
    summary: "According to a radiogram relayed in the writings of Felix Zigel, the Soviet ship Nooget in the Gulf of Guayaquil, Ecuador, saw a white luminescent sphere rise from the water ahead, fly around the ship, hover 20 metres above it, climb, zigzag and dive back into the sea."
    category: event
    significance: notable
    cue: 584
    entities:
      - "Soviet Ship Nooget USO Sighting"
      - "Felix Zigel"
  - date: "1977-10-07"
    title: "Vulga: nine discs circle a Soviet repair ship"
    summary: "In the Barents Sea, the radar of the Soviet submarine repair ship Vulga picked up an object about 60 miles out; Captain Tanton reached the bridge to see nine bright discs arrive from the northeast and circle the ship for 18 minutes. Communications failed during the encounter, as in the 1976 Tehran incident, and recovered once the discs left."
    category: event
    significance: major
    cue: 439
    entities:
  ...
  - date: "1977"
    title: "Smirnov directive mandates Soviet naval UFO reporting"
    summary: "Alarmed by the Vulga encounter, Fleet Admiral Nikolai Smirnov issued a directive requiring Soviet hydrographic, scientific-research and reconnaissance ships to report UFO sightings, likened in the video to JANAP 146C and OPNAV 3820. It was authorized by naval officer and ufologist Vladimir Azhazha."
    category: policy
    significance: major
    cue: 473
    entities:
      - "Fleet Admiral Nikolai Smirnov"
      - "Vladimir Azhazha"
---
::
...
The video opens with the numbers: of Blue Book's 13,000-plus sightings, 258 came from ships and 13 met the program's merit standards. Gerb recommends a report on maritime UFO and USO research in Blue Book. It breaks the 258 ship cases down into 155 in the Pacific and 104 in the Atlantic, which Gerb reads as a possible Pacific hotspot, and he stresses that sightings over water are not isolated incidents. He puts the small total down to OPNAV 3820, which sent Navy reports to only three offices:

::wiki-org-chart
---
root:
  name: OPNAV 3820
  label: 1952 Navy directive
  note: "Restricted Navy UFO sighting reports to three recipients. The video blames it, together with JANAP 146C, for how few USO cases reached Blue Book."
  children:
    - name: Air Force Technical Intelligence Center
      label: Recipient
    - name: USAF Intelligence
      label: Recipient
    - name: Office of Naval Intelligence
      label: "Recipient, via the Director of Naval Intelligence"
---
::
...
The main case is the [[Soviet Submarine Repair Ship Vulga Sighting|Vulga]] encounter in the Barents Sea on 7 October 1977. The ship's radar picked up an object about 60 miles out; Captain Tanton reached the bridge to see nine bright discs come in from the northeast and circle the ship for 18 minutes. Ship communications failed, much as Major Jafari's did in the [[1976 Tehran UFO Incident]], and came back when the discs left. The case also appears on pages 29 to 30 of [[Jacques Vallee|Jacques Vallée]]'s *UFO Chronicles of the Soviet Union: A Cosmic Samizdat*. The Soviet navy responded with a formal order:

::wiki-chain{video="Yn-83KbgRN8" video-title="USO Case Book: Unidentified Submerged Objects Throughout History"}
---
kind: consequence
caption: "How the Vulga encounter led to a fleet-wide duty to report UFO sightings, as the video tells it."
steps:
...
- **1880, Shahian.** Off the [[Malabar Coast, India|Malabar Coast]], Commander Harris and his third officer saw a milky white circle "resembling the nebula" ([[SS Shahian Circular Object Sighting]]).
...
On a map, the video's light-wheel cases fall along one stretch of sea, from the Persian Gulf along the coast of India to the waters around Singapore:
...
caption: "Where the video's light-wheel cases were seen, 1873–1910. The video names only the sea or coast for each case, so each pin marks that sea or coast (coordinates from Wikipedia and Wikidata) rather than a ship's reported position. The Adhy was bound for Singapore, but the video gives no position for its sighting."
pins:
...
Some attribute the wheels to a rare interaction between bioluminescent algae and pressure waves in otherwise calm water. Gerb says there is no consensus on this explanation, but he links a paper that explores it in the video description.
::
::

## Recurring Signatures

Gerb's closing argument is that Australian, Blue Book and Soviet files describe very similar experiences. These are the parallels he draws across the video:

::wiki-grid{cols=2}
::wiki-panel{title="Three flashes before entering the sea"}
The 1959 SS City of Alako object flashed three times and submerged; the 1967 Australian Department of Works sightings were accompanied by three distinct flashes on return to the sea.
::
::wiki-panel{title="A quivering, wobbling egg"}
The 1950 MV Marala half-egg had a rotary, wobbling motion; the 1947 Port Augusta railway workers described egg-shaped objects quivering as they rose.
::
::wiki-panel{title="Entering water without disturbing it"}
The 1966 Fraser Island cigars submerged without breaking the surface, like the HMNZS *Southland* case Kevin Knuth has described; the 1960 Ascension Island light showed no waves breaking over it.
::
::wiki-panel{title="Instruments and engines fail"}
The 1964 Groote Eylandt lights sent a compass haywire; the 1970 Kamchatka motorboat engine stalled; the 1977 Vulga's communications failed until the discs left.
::
::
...
- [YouTube](https://www.youtube.com/watch?v=Yn-83KbgRN8) — UAP Gerb
- *Russia's USO Secrets* — [[Paul Stonehill]] and [[Philip Mantle]]
- *UFO Chronicles of the Soviet Union: A Cosmic Samizdat* — [[Jacques Vallee|Jacques Vallée]], pp. 29–30
- *Flying Saucer Review*, July–August 1966
- *Scientific American*, relaying the nautical-meteorological annual of the [[Danish Meteorological Institute]]
- National Library of Australia — *The Argus*, 1873

## Related Pages

- **People**: [[Luis Elizondo]], [[Kevin Knuth]], [[George Knapp]], [[Paul Stonehill]], [[Philip Mantle]], [[Jacques Vallee|Jacques Vallée]], [[Felix Zigel]], [[Fleet Admiral Nikolai Smirnov]], [[Vladimir Azhazha]]
- **Organizations**: [[Project Blue Book]], [[Project Sign]], [[Project Grudge]], [[Air Force Technical Intelligence Center]], [[Office of Naval Intelligence]], [[US Hydrographic Bureau]], [[Danish Meteorological Institute]], [[Sol Foundation]]
- **Locations**: [[Ascension Island]], [[Kamchatka Peninsula]], [[Cape Race, Newfoundland]], [[Malabar Coast, India]], [[Port Augusta, South Australia]], [[Frasier Island, Australia]]
- **Concepts**: [[Unidentified Submerged Object (USO)]], [[Trans-Medium Vehicle]], [[Maritime Light Wheel]], [[OPNAV 3820]], [[JANAP 146c|JANAP 146C]]
- **Events**: [[MV Marala North Atlantic Sighting]], [[SS City of Alako Hawaiian Islands Sighting]], [[Ascension Island USO Sighting]], [[SS Morgantown Victory Sighting]], [[Soviet Submarine Repair Ship Vulga Sighting]], [[Kamchatka Lake USO Sighting (1970)]], [[Soviet Ship Nooget USO Sighting]], [[Port Augusta USO Sighting]], [[Frasier Island USO Sighting]], [[SS Siberian USO Encounter]], [[Fort Salisbury USO Sighting]], [[Ship Adhy Maritime Light Wheel Sighting]], [[Persian Gulf USO Flap]], [[SS Patna Light Wheel Sighting]], [[SS Kila Light Shaft Sighting]], [[SS Shahian Circular Object Sighting]], [[SS Bintang Light Wheel Sighting]], [[Dutch Steamship Valentin Hovering Object Sighting]], [[1976 Tehran UFO Incident]], [[Caribbean Island Cruise Missile Recovery USO Encounter]]
