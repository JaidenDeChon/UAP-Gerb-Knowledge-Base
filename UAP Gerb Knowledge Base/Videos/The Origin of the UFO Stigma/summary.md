...
events:
  - date: "1947-09-23"
    ...
    cue: 203
  - date: "1948"
    title: "Project Sign begins"
    summary: "The first official US government program investigating UFOs. Its written report states that some reports present actual objects of undeterminable origin, and Edward J. Ruppelt later said Sign endorsed the interplanetary explanation for some unexplained cases. Every Sign report had to go to the Army and Navy Research and Development Board, the USAF Scientific Advisory Group and the Atomic Energy Commission."
    category: program
    significance: major
    entities:
      - "Project Sign"
  ...
  - date: "1952-07-29"
    ...
    cue: 541
  - date: "1952-12"
    title: "Ruppelt barred from briefing the CIA"
    summary: "A month before the Robertson Panel, USAF Colonel Donald L. Bower forbids Captain Edward J. Ruppelt from visiting the CIA's Office of Special Investigations to share compelling UFO data."
    category: event
    entities:
      - "Edward J. Ruppelt"
    cue: 712
  ...
  - date: "1953-08-26"
    ...
    cue: 756
  - date: "1960"
    title: "Grudge report published"
    summary: "Though Grudge was officially terminated in 1949, a full 707-page report of its case analysis is published in 1960, and its records are updated until 1999."
    category: document
    entities:
      - "Project Grudge"
    cue: 278
  - date: "1966-03"
    title: "Dexter, Michigan sighting called swamp gas"
    summary: "Hynek explains the Dexter, Michigan mass sighting as swamp gas, the explanation that most dissatisfied Congressman Gerald Ford."
    category: event
    entities:
      - "J. Allen Hynek"
      - "Gerald Ford"
  ...
  - date: "1966-08"
    ...
    cue: 999
  - date: "1967"
    title: "Condon: 'not supposed to reach that conclusion'"
    summary: "In a public lecture Condon says the government should not study UFOs because the subject is nonsense, adding that he is not supposed to reach that conclusion for another year."
    category: event
    entities:
      - "Edward Condon"
    cue: 971
  - date: "1969-01"
    ...
    cue: 1099
  - date: "1969"
    title: "National Academy of Sciences endorses Condon"
    summary: "The Academy's review calls Condon's work sound, approves his methodology and agrees there should be no more formal UFO investigation."
    category: organization
    entities:
  ...
  - date: "1969-12"
    ...
    cue: 1322
  - date: "1970"
    title: "AIAA agrees little of value found"
    summary: "The American Institute of Aeronautics and Astronautics issues statements agreeing that little of value had come from scientific UFO study."
    category: organization
    entities:
...
## Sign and Grudge (1948-1951)

Gerb notes that the story could begin with the 1947 Kenneth Arnold sightings or the [[Roswell Crash]], but chooses to start "where our paper trail leads us": the first official government program.
...
claim:
  ...
  by: "Robertson Panel"
  date: "1953-01"
  text: "All national security agencies should strip UFOs of \"special status\" and suggest to the public that there is no legitimate evidence of their existence."
  cue: 682
responses:
  - by: "Thornton Page"
    stance: challenges
  ...
  - by: "Gerb"
    stance: challenges
    text: "The panel sat a month after Ruppelt was forbidden to take compelling data to the CIA. Its conclusions were predetermined, to reduce UFOs to nonsense and prosaic misidentification."
    cue: 726
  - by: "J. Allen Hynek"
    stance: challenges
    text: "The panel was handed \"the unwritten law of the Air Force\": don't rock the boat, play it cool, don't get the public excited."
    cue: 738
---
::

The panel's timing is part of Gerb's case: a month earlier, in December 1952, USAF Colonel Donald L. Bower had forbidden Captain Edward J. Ruppelt from visiting the CIA's Office of Special Investigations to share compelling UFO data. [[Thornton Page]], a signatory, later admitted (in a statement Gerb dates to 3 October 1993) that the chairman had told members in advance to debunk everything put before them.
...
claims:
  - title: "Swamp gas at Dexter"
    by: "J. Allen Hynek"
    date: "1966-03"
    where: "Dexter, Michigan"
    text: "The Dexter, Michigan mass UFO sighting is explained as swamp gas."
    cue: 818
    responses:
      - by: "Gerald Ford"
        stance: challenges
        text: "Dissatisfied with explanations such as swamp gas and weather balloons, he called for a congressional investigation, and was ridiculed for it."
        cue: 811
  - title: "No unexplained radar cases"
    by: "Hector Quintanilla"
    date: "1966-04-05"
    where: "House Armed Services Committee"
    text: "Project Blue Book has \"no radar cases that are unexplained\"; most radar detections are temperature inversions or misidentifications."
    cue: 839
    responses:
      - by: "Gerb"
        stance: challenges
      ...
      - by: "J. Allen Hynek"
        stance: challenges
        text: "Later pointed out radar detections that stumped Blue Book: Goose Bay (1951), Lakenheath (1956) and Shreveport (1957)."
        cue: 862
---
::

Tired, as he put it, of being a "puppet of the Air Force" who "only says what the Air Force wants me to say", Hynek brought a surprise statement to the hearing asking the Air Force to commission a civilian panel of physical and social scientists to examine the UFO problem critically. Both Hynek and physicist [[James McDonald]] asked for seats on that panel and were refused.
...
---
term: "Conclusion"
caption: "Condon's summary conclusion, with the challenges and endorsements the video quotes. A clip Gerb plays adds that Condon wrote the summary himself and \"completely neglected the contents of the report\"."
claim:
  title: "Nothing added to science"
  by: "Edward Condon"
  date: "1969-01"
  where: "Condon Report, conclusions and recommendations"
  text: "Nothing has come from the study of UFOs in the past 21 years that has added to scientific knowledge; further extensive study probably cannot be justified."
  cue: 1115
responses:
  - by: "James McDonald"
    stance: challenges
  ...
  - by: ["James McDonald", "J. Allen Hynek"]
    stance: challenges
    text: "The committee ignored key evidence and could not explain 25 to 30% of the cases it examined, a finding missing from the summary."
    cue: 1173
  - by: "American Association for the Advancement of Science"
    where: "Science"
    stance: supports
    text: "\"Unquestionably the most thorough and sophisticated investigation\" of the UFO phenomenon ever conducted."
    cue: 1238
  - by: "National Academy of Sciences"
    date: "1969"
    stance: supports
    text: "Reviewed the work as sound, approved its methodology and agreed there should be no further formal UFO investigation."
    cue: 1249
  - by: "American Institute of Aeronautics and Astronautics"
    date: "1970"
    stance: supports
    text: "Agreed that little of value had been uncovered by scientific UFO studies."
    cue: 1265
---
::

The news media praised the report almost universally. Some reviews likened continued belief in UFOs to belief in a flat Earth, ghosts or Bigfoot; others predicted interest would fade within a few generations. Project Blue Book was terminated in December 1969. UFOs were now lumped in with ghosts, Bigfoot and conspiracy, and the word became synonymous with "tin foil hat" cranks rather than accredited physicists like Hynek and McDonald who wanted to study it.
...
subjects:
  ...
  - name: "Robertson Panel"
    note: "CIA, January 1953"
  - name: "Condon Committee"
    note: "Univ. of Colorado, 1966–1968"
rows:
  - attribute: "Stated task"
    cells:
      - "Investigate flying-disc reports"
      - "Alleviate public anxiety; explain sightings away"
      - "Judge the national-security threat; analyse the data"
      - "Review the Air Force case files"
      - "An independent scientific study"
  - attribute: "Led or set up by"
    cells:
      - "Gen. Nathan Twining"
      - "US Air Force"
      - "US Air Force; Hynek as scientific adviser"
      - "Howard P. Robertson, CIA consultant"
      - "Edward Condon, with Robert J. Low"
  - attribute: "Official verdict"
    cells:
      - "Some reports are real objects of undeterminable origin"
      - "Lubbock Lights: migrating birds"
      - "12,618 reports; 701 unexplained"
      - "Strip UFOs of \"special status\""
      - { text: "Nothing added to science; 25–30% of cases unexplained", mark: disputed }
  - attribute: "How it ended"
    cells:
      - "Shut by Gen. Hoyt Vandenberg for \"lack of proof\""
      - "Terminated 1949; report published 1960"
      - "Terminated December 1969"
      - "Followed by AFR 200-2"
      - "Endorsed by the National Academy of Sciences"
  - attribute: "Gerb's reading"
    cells:
      - { text: "Reports went to the AEC: the paper trail starts here", cue: 240 }
      - { text: "\"The first real breadcrumbs\" of shaping perception", cue: 302 }
      - { text: "\"Where the true UFO stigma was born\"", cue: 399 }
      - { text: "Conclusions predetermined", cue: 726 }
      - { text: "\"Conclusions before findings\"", cue: 1013 }
---
::
...
entries:
  ...
  - name: "Howard P. Robertson"
    role: "Physicist and CIA consultant"
    note: "Chaired the 1953 panel that recommended stripping UFOs of \"special status\"; according to Thornton Page, told members in advance to debunk."
  - name: "Thornton Page"
    role: "Astronomer; Robertson Panel signatory"
    note: "His later admission that the panel was told to \"reduce public concern\" is Gerb's evidence that its conclusions were predetermined."
  ...
  - name: "Robert J. Low"
    role: "Condon Committee project coordinator"
    note: "Wrote the 1966 \"trick\" memo on appearing objective while signalling disbelief, which Gerb calls a perfect description of how the stigma would operate."
  - name: "James McDonald"
    role: "Physicist"
    note: "Refused a seat on the civilian panel; made Low's memo public and called the Condon Report inadequate."
  - name: "General Samford"
    role: "USAF major general; director of Air Force intelligence"
    note: "At the July 1952 Pentagon press conference, explained away most reports while conceding \"credible observers of relatively incredible things\"."
---
::
...
- Project Blue Book analysed 12,618 reports, 701 unexplained; Hynek said it was not a scientific project and that the Air Force suppressed interesting cases.
- The Robertson Panel reviewed 23 of 2,331 cases, and its conclusions were predetermined: signatory Thornton Page said the chairman told members to debunk all reports beforehand.
- Air Force Regulation 200-2 (1953) sent confirmed UFO reports to Air Force intelligence instead of Blue Book, keeping credible sightings from Congress and the public.
- Blue Book head Hector Quintanilla told Congress in 1966 that there were no unexplained radar cases, which Gerb calls an irrefutable lie, citing Goose Bay (1951), Lakenheath (1956) and Shreveport (1957).
- Hynek and James McDonald were refused seats on the civilian panel; Edward Condon was chosen instead and paid $313,000.
- Robert J. Low, allegedly a former CIA man, wrote a 1966 memo describing a "trick" to appear objective while signalling disbelief by studying witnesses rather than the phenomenon.
- The Condon Committee could not explain 25–30% of its cases, a finding Condon's summary omitted; the report was nonetheless praised by the news media, *Science*, the National Academy of Sciences and the AIAA.
- Sign, Grudge, Blue Book, the Robertson Panel and the Condon Committee were all used as tools to discredit UFOs publicly while real research continued covertly; together they are the "sophisticated disinformation campaigns" David Grusch describes.

## Sources

- [YouTube](https://www.youtube.com/watch?v=xKArN8S9bnM) — UAP Gerb
...
- **Concepts**: [[UFO Stigma]], [[Robertson Panel]], [[USAF Regulation 200-2]], [[Condon Report]]
