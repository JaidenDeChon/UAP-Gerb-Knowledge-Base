...
eras:
  - id: crashes
    ...
    from: 1949
    to: 1957
    summary: "Sandia passes to AT&T, an object is said to be nearly obliterated at El Indio on the day of a nationwide alert, and five years later Willingham watches another come down near Langtry."
    anchor: "two-cases-one-name"
  - id: papertrail
    label: "The Paper Trail"
    from: 1965
    to: 2008
    summary: "Willingham's story surfaces in a small Pennsylvania paper, is sworn to in an affidavit with a different plane and year, and reaches book form in The Other Roswell."
    anchor: "the-colonel-robert-willingham-case-1955"
  - id: unravels
...
events:
  ...
  - date: "1950-12-06"
    title: "El Indio crash, per the Eisenhower Briefing Document"
    cue: 125
    summary: "The alleged MJ-12 briefing document for the incoming president describes an object of similar origin to Roswell striking the ground at high speed in the El Indio area of the Texas-Mexico border, between El Indio and Guerrero, 75 miles southeast of Del Rio. It was nearly obliterated; the recovered material went to the Atomic Energy Commission's Sandia facility in New Mexico for study."
    category: event
    significance: major
    entities:
  ...
  - date: "1954-05-14"
    ...
    significance: notable
  - date: "1955"
    title: "Willingham's F-86 flight sees a bright object on a Carswell mission"
    cue: 377
    summary: "On a spring day, Willingham and other F-86 pilots escorted B-47s from Carswell AFB on a Cold War simulation exercise (his call sign 'Willie Eddie'). After radio reports of fast unknowns picked up by distant early warning radar in Canada, a bright object 'like a star' approached at an estimated 2,000 mph, turned 90 degrees toward Mexico, threw off 'a lot of sparks' and tilted down at 45 degrees. George Smithson and other pilots said in the debrief that they had seen it."
    category: event
    significance: major
    entities:
      ...
      - "DEW Radar Systems"
  - date: "1955"
    title: "Willingham overflies a disc-shaped wreck near Langtry"
    cue: 571
    summary: "Given permission by Denver flight control ('go check out what it was and where it hit'), Willingham came in from San Angelo and dropped to about 800 feet near Langtry. He saw a disc-shaped craft that had struck the ground just south of the Rio Grande, on the Mexican side, and skidded about 300 feet."
    category: event
    significance: major
    entities:
      - "1955 Langtry UFO Crash"
      ...
      - "Langtry, Texas"
  - date: "1955"
    title: "Willingham and Perkins land at the crash site"
    cue: 716
    summary: "Returning privately in a 1947 Aeronca Champion with his friend Jack Perkins, Willingham reached the site at about 4 pm. Mexican soldiers stood a perimeter but made no retrieval effort. A Lieutenant Martinez let Willingham, in USAF fatigues, approach without Perkins, saying the American Air Force would 'be here very soon to clean this all up'. Willingham took a small piece of shiny metal."
    category: event
    significance: major
    entities:
      - "1955 Langtry UFO Crash"
      ...
      - "Jack Perkins"
  - date: "1955"
    title: "Fragment vanishes at a Marine Corps metallurgy lab"
    cue: 909
    summary: "After failing to cut or deform the light, honeycombed, grayish-silver fragment, Willingham sent it to a USMC metallurgy lab in Hagerstown, Maryland. When he called back, the lab said the receiving major had never worked there and had no record of tests. A USAF intelligence general had already told him to say nothing of what he saw 'down on the border'."
    category: event
    significance: notable
    entities:
      - "Robert Willingham"
  ...
  - date: "1993"
    ...
    entities:
      ...
      - "TR-3B"
  - date: "1995"
    title: "Dennis Stacy's 'Crash at El Indio' in Omni"
    cue: 1332
    summary: "After a 1990-94 effort to pin down the site, Stacy found a resident, Senor Flores, who saw a ball of fire fall onto a neighbouring ranch north of the river at El Indio and start a grass fire. A day or two later a military contingent from Piedras Negras cordoned it off and hauled something away by truck. Stacy thought, without confirmation, it might be a 1944 Civil Air Patrol crash."
    category: document
    significance: notable
    entities:
      - "Dennis Stacy"
      - "El Indio, Texas"
  - date: "2002"
    title: "Jack Perkins dies; his name is revealed"
    cue: 626
    summary: "Willingham's companion on the flight to the wreck, a Pennsylvania electronics engineer and Civil Air Patrol colleague, faced no reprisals and was named only after his death."
    category: person
    significance: minor
    entities:
      - "Jack Perkins"
  ...
  - date: "2012-07-24"
    ...
    entities:
      ...
      - "Robert Willingham"
  - date: "2015"
    title: "Robert Willingham dies"
    cue: 304
    summary: "Willingham died in 2015, after the interviews that underpin The Other Roswell."
    category: person
    significance: minor
    entities:
      - "Robert Willingham"
  - date: "2018-06"
    title: "Eric Davis names Del Rio on Coast to Coast AM"
    cue: 72
    summary: "Talking reverse engineering with George Knapp, Dr Eric Davis of the Wilson-Davis memo said that after Roswell, 'Del Rio, Texas, that was a 1950s case' was another good bet, and that others were still classified. The video opens on this remark."
    category: event
    significance: notable
    entities:
      - "Eric Davis"
...
They arrived at about 4 pm. The craft lay in roughly three sections with debris "some little and some large chunks about as big as a good sofa chair". The main body was a flattened disc 20 to 25 feet across, split in two, with half of it embedded in a sandy mound. A dome-shaped section 12 to 15 feet long lay 50 feet beyond it. Mexican soldiers in jeeps and cars stood a perimeter, but no trucks or aircraft were there and nobody was gathering anything. A Lieutenant Martinez from Mexico City noticed Willingham's USAF fatigues and offered to take him closer, without Perkins. He said: "We can't let anyone close to it. The American Air Force will be here very soon to clean this all up." Willingham took the soldiers to be from the nearest army base, at Ciudad Acuña, about 100 miles away. The host found no record of Martinez. He notes that the pattern of a foreign government guarding a wreck for an American team recurs elsewhere, as in the 1978 Bolivia retrieval from his [[Project Moon Dust]] video.

### The fragment

Before leaving, Willingham picked up a small piece of shiny metal. Back at base he gave an oral and written report to reserve commander Colonel Miller, and was soon warned to keep quiet. A general in USAF intelligence told him: "Don't say anything about what you saw down on the border."

::wiki-grid{cols=2}
::wiki-panel{title="What Willingham described"}
- Rigid and unyielding, but extremely light
- Grayish silver, reminding him of magnesium steel
- Small honeycomb-patterned holes along one side, which he took to be for shedding heat
- No inscriptions, symbols or characters, unlike the Roswell material
- Resisted his deformation tests, including a cutting torch
- Kept for four days; no photographs taken
::
::wiki-panel{title="What happened to it"}
- Sent to a USMC metallurgy lab in Hagerstown, Maryland, where a major received it and was "perplexed by the structure"
- When Willingham called back, the lab said no such major had worked there and it had no record of tests
- Up the chain of command, he was told it would be in his best interest to drop the matter
::
::
...
[[Dennis Stacy]] spent 1990 to 1994 trying to locate the crash and decide whether the document described a real event. He published the results in *Omni* in 1995 as "Crash at El Indio: Alleged UFO Crash in Mexico". He found a resident, Señor Flores, who had been working his family's land north of the river at El Indio when a ball of fire fell onto the neighbouring ranch and set the grass alight. A day or two later a military contingent arrived from Piedras Negras, blocked off the site and hauled something away by truck. Flores did not know whether the soldiers were Mexican, American or both, or whether it was wreckage they removed. Stacy suggested, without confirmation, that he might be remembering a Civil Air Patrol plane crash of 16 January 1944.
...
entries:
  - name: "Robert Willingham"
    role: "Air Force Reserve colonel; Langtry crash witness"
    note: "Watched the object fall in 1955, visited the wreck and kept a fragment. His changing aircraft, year and account of bodies are the video's central credibility problem."
  - name: "Jack Perkins"
    role: "Civil Air Patrol colleague of Willingham"
    note: "Flew with him to the wreck in a 1947 Aeronca Champion but was kept back by the Mexican soldiers. He was named only after his death in 2002."
  - name: "George Smithson"
    role: "Pilot on the 1955 mission"
    note: "One of the pilots who said in the post-incident debrief that they had seen the object."
  - name: "William Drager"
    role: "Former USAF member; documentary interpreter"
  ...
  - name: "Todd Zechel"
    role: "UFO researcher"
    note: "Obtained Willingham's 1977 affidavit, and reportedly a USAF document on a foreign object taken to Carswell in December 1950, which he never produced."
  - name: "Dennis Stacy"
    role: "Journalist, Omni"
    note: "Searched for the El Indio site from 1990 to 1994 and found the witness Señor Flores."
  - name: "Eric Davis"
    role: "Physicist; Wilson-Davis memo"
    note: "Named Del Rio as a 1950s crash case on Coast to Coast AM in 2018, the remark that opens the video."
  - name: "General Ramey"
    role: "USAF general"
...
- Eric Davis told George Knapp on *Coast to Coast AM* in June 2018 that "Del Rio, Texas, that was a 1950s case" was a strong bet for UFO reverse engineering after Roswell, and that other cases remain classified.
- The alleged Eisenhower Briefing Document describes a 6 December 1950 crash between El Indio, Texas, and Guerrero, Mexico, in which a nearly obliterated craft was recovered and sent to the Atomic Energy Commission's Sandia facility.
- Robert Willingham claimed that in spring 1955, escorting B-47s from Carswell AFB, he saw an object travelling at about 2,000 mph turn 90 degrees, throw off sparks and go down across the Rio Grande from Langtry, Texas; George Smithson and other pilots said in the debrief that they had seen it.
...
- [YouTube](https://www.youtube.com/watch?v=8S9qdRWSnD8) — UAP Gerb

## Related Pages

- **People**: [[Robert Willingham]], [[Jack Perkins]], [[George Smithson]], [[William Drager]], [[Noe Torres]], [[Ruben Uriarte]], [[Todd Zechel]], [[Dennis Stacy]], [[Eric Davis]], [[George Knapp]], [[Jeff Rense]], [[Kevin Randle]], [[Leonard Stringfield]], [[General Ramey]], [[J. Edgar Hoover]], [[Steven Greer]], [[Edgar Fouche]], [[Stanton Friedman]], [[Arthur Stansel Jr.]], [[Harry Truman]]
- **Organizations**: [[Majestic 12]], [[Sandia National Laboratories]], [[Atomic Energy Commission]], [[AT&T]], [[Lockheed Martin]], [[Battelle Memorial Institute]], [[Disclosure Project]], [[National Investigations Committee on Aerial Phenomena]], [[US Air Force]]
- **Locations**: [[Del Rio, Texas]], [[Langtry, Texas]], [[El Indio, Texas]], [[Guerrero, Mexico]], [[Carswell Air Force Base]], [[Kirtland Air Force Base, New Mexico]]
- **Concepts**: [[Crash Retrieval]], [[Eisenhower Briefing Document]], [[MJ-12 Documents]], [[Condon Report]], [[DEW Radar Systems]], [[Hottel Memo]], [[Wilson-Davis Memo]], [[TR-3B]]
