...
routes:
  - path: [1, 2]
    label: "JK 297 diverts to Manises"
  - path: [3, 4]
    label: "Mirage F1 sent toward the echo near Sagunto"
    style: dashed
---
::
...
subjects:
  ...
  - name: "2004 Nimitz UAP Encounter (Tic Tac)"
    note: "Off San Diego, 2004"
rows:
  - attribute: "Pilot and aircraft"
    cells:
      - { text: "Capt. Fernando Cámara, Mirage F1", cue: 377 }
      - { text: "Maj. Parviz Jafari, F-4 Phantom II", cue: 611 }
      - { text: "Cdr. David Fravor and other Navy jets", cue: 589 }
  - attribute: "What was seen"
    cells:
      - "A truncated cone of bright, changing colour"
      - { text: "A diamond-shaped craft; a smaller sphere separated and approached", cue: 656 }
      - "The Tic Tac objects"
  - attribute: "Speed and movement"
    cells:
      - "Mach 1.4 needed to see it; it darted away on every approach"
      - { text: "At Mach 1, saw it jump 10° (about 26 miles) in under a second", cue: 638 }
      - { mark: unknown }
  - attribute: "What was jammed"
    cells:
      - { text: "Flight electronics, and his infrared-missile lock", mark: same, cue: 444 }
      - { text: "All instruments, including targeting and radio", mark: same, cue: 670 }
      - { text: "The jets' radar and sensors", mark: same, cue: 594 }
  - attribute: "Other aircraft affected"
    cells:
      - { mark: unknown }
      - { text: "The first F-4 lost instruments and radio and turned back", cue: 627 }
      - "Fravor says the objects jammed \"the jets\""
  - attribute: "How it ended"
    cells:
      - { text: "Object left toward Africa; he returned low on fuel", cue: 456 }
      - { text: "He evaded; instruments and radio came back", cue: 687 }
      - { mark: unknown }
---
::
...
claims:
  - title: "Optical illusions"
    ...
    date: "1980-09"
    text: "After deputies asked for an official explanation, the sighting was dismissed as \"a series of freak optical illusions\"."
    cue: 468
    responses:
      - by: "Gerb"
        stance: challenges
  ...
  - title: "The refinery's flare stacks"
    ...
    responses:
      - by: "Gerb"
        stance: challenges
        text: "Stationary lights can't approach an aircraft, hold its altitude through evasive manoeuvres and keep station at half a mile to 5 miles. The co-pilot and flight mechanic backed the landing, so they would have had to share the anxiety attack."
        cue: 738
  - title: "Stars and planets"
    by: "Sceptics"
    text: "The moving lights seen by airport staff and Marines, including the object near the runway, were Venus or Jupiter."
    cue: 772
    responses:
      - by: "Gerb"
        stance: challenges
  ...
  - title: "US Sixth Fleet interference"
    by: "Sceptics"
    text: "With the Iran hostage crisis under way, electronic emissions from two helicopter carriers of the US Sixth Fleet in the Mediterranean scrambled the Mirage's instruments."
    cue: 814
    responses:
      - by: "Fernando Cámara"
        stance: challenges
        text: "He was too far from the fleet for it to interfere with his navigation, radio and emergency controls."
        cue: 840
      - by: "Gerb"
        stance: challenges
        text: "It doesn't explain the cone Cámara saw with his own eyes, an object that sped away from a jet at Mach 1.4, or the jamming of his infrared-missile lock."
        cue: 853
---
::
...
---
entries:
  - name: "Francisco Javier Lerdo de Tejada"
    role: "Captain, TAE flight JK 297"
    note: "Diverted his Super Caravelle and its 109 passengers to Manises rather than fly on beside lights that mirrored his manoeuvres."
  - name: "José Ramón Zuazu"
    role: "Co-pilot, TAE flight JK 297"
    note: "Backed the decision to land, which is why Gerb rejects the idea that the captain merely had an anxiety attack."
  - name: "Francisco Javier Rodriguez"
    role: "Flight mechanic, TAE flight JK 297"
    note: "First to spot the two red lights, at about 23:05 near 23,000 feet."
  - name: "Fernando Cámara"
    role: "Spanish Air Force captain, Mirage F1 pilot"
...
- The [[Manises UFO Incident]] is, in Gerb's words, the first recorded case of a commercial airliner being grounded because of a UFO, and Spain's most famous UFO case.
- About 23:05 on 11 November 1979, near 23,000 feet over the Mediterranean, the crew of [[TAE (Trabajos Aéreos y Enlaces)|TAE]] flight JK 297 saw two powerful red lights with no visible solid body; [[Barcelona Air Traffic Control]] reported no other aircraft on or near the route.
- When the captain changed altitude, the lights allegedly mirrored the aircraft's trajectory and held half a mile to five miles away, and he diverted to [[Manises Airport, Valencia, Spain|Manises]] with 109 passengers rather than risk a collision.
- Shortly before the landing the crew detected three new radar signals of about 200 metres each; the lights were seen by airport staff and personnel at the neighbouring air base, and ground crew lit the runway emergency lights when one passed close by.
- Scrambled from [[Los Llanos Airbase, Spain|Los Llanos]] at about 00:40, Mirage F1 pilot [[Fernando Cámara]] needed Mach 1.4 (1,074 mph) just to see a truncated cone of changing colour.
- Chasing a second echo near [[Sagunto, Spain|Sagunto]], Cámara reported jammed flight electronics, a continuous-wave missile-radar lock warning and a jammed infrared-missile lock; the object then left toward Africa and he returned low on fuel after nearly ninety minutes.
- The [[Spanish Parliament]] dismissed the case in September 1980 as "a series of freak optical illusions".
- Sceptics attributed the lights to the Escombreras refinery near Cartagena and to Venus or Jupiter, and the jamming to two helicopter carriers of the [[US 6th Fleet]]; Cámara said he was too far from the fleet for it to affect his systems.
- Gerb places the Mirage's jammed sensors in a pattern with [[Parviz Jafari]]'s 1976 Tehran intercept and [[David Fravor]]'s 2004 Tic Tac encounter, and concludes the case is legitimate.

## Sources

- [YouTube](https://www.youtube.com/watch?v=K_BZkOAw6E0) — UAP Gerb

## Related Pages

- **People**: [[Francisco Javier Lerdo de Tejada]], [[José Ramón Zuazu]], [[Francisco Javier Rodriguez]], [[Fernando Cámara]], [[David Fravor]], [[Parviz Jafari]]
- **Organizations**: [[TAE (Trabajos Aéreos y Enlaces)]], [[Barcelona Air Traffic Control]], [[Spanish Parliament]], [[US 6th Fleet]]
- **Locations**: [[Manises Airport, Valencia, Spain]], [[Manises Air Force Base, Spain]], [[Mallorca, Spain]], [[Salzburg, Austria]], [[Las Palmas, Spain]], [[Los Llanos Airbase, Spain]], [[Sagunto, Spain]]
- **Events**: [[Manises UFO Incident]], [[1976 Tehran UFO Incident]], [[2004 Nimitz UAP Encounter (Tic Tac)]]
- **Concepts**: [[UFO Stigma]]
