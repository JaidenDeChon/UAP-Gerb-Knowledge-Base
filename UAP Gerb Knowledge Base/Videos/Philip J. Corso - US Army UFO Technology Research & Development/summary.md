...
stats:
  - value: 21
    label: Years in the Army
    hint: "1942–1963"
  - value: "$2B"
    label: Claimed division budget
    hint: "Over $10.5 billion today"
  - value: 176
    label: Manuscript pages
    hint: "Corso's manuscript, Dawn of a New Age"
  - value: "1h32m"
    label: Runtime
---
::
...
This video is UAP Gerb's full analysis of retired US Army Lieutenant Colonel [[Philip J. Corso]] (1915–1998). Corso claimed that as chief of a little-known [[U.S. Army Foreign Technology Division|Army Foreign Technology Division]] under Lieutenant General [[Arthur Trudeau]], he handled material from the 1947 [[Roswell Crash]] and fed it into American industry. From the start Gerb sets aside the 1997 bestseller *The Day After Roswell*, co-written with [[Bill Burns|William J. Birnes]], and works only from *Dawn of a New Age*, the 176-page manuscript of Corso's own notes that his son [[Philip Corso Jr.]] released after his death. Gerb argues that most of the embellishments critics attack were added in the book.

Corso's claims come in four layers:

- In a sworn 1998 affidavit, he said he saw a four-foot non-human body in a crate at [[Fort Riley, Kansas]], in July 1947.
- He said that in 1961 Trudeau gave him the "Roswell File" of field reports, Walter Reed autopsy reports and debris.
- He said his division seeded that material into companies such as [[Bell Labs]] and [[Sperry Rand]] under the cover of ordinary research contracts. By his account, this gave rise to night vision, fiber optics, the integrated circuit and the laser.
- At the very end of the manuscript, he describes a telepathic meeting with a non-human being at [[White Sands Missile Range]] in 1957–58.
...
Gerb's main argument is that the Army office Corso ran was real but is almost invisible. It appears in Corso's own military records but in no FOIA release, newspaper or article. It is overshadowed by the far better-known [[Air Force Foreign Technology Division]] at Wright-Patterson. If Corso is right, Gerb says, the Army's Foreign Technology Division, formed in 1960, may have been one of the first structured US UFO legacy programs. It worked through corporations, universities and semi-private research centers, as later accounts say [[Waived Unacknowledged Special Access Programs (USAPs)|unacknowledged special access programs]] do. By the end of the video Gerb is largely favourable to the manuscript, though he says he cannot judge the technology claims and is still troubled by the White Sands encounter.

## Chronology

::wiki-timeline{video="_sv0Otxtcn4" video-title="Philip J. Corso - US Army UFO Technology Research & Development"}
---
help: "The bar of years above the list runs from 1942, when Corso enlisted, to 2024, when his FBI file was released. Each entry is a coloured mark at its year, and taller marks are major entries. Click the bar to jump to a year. The shaded sections of the bar are the video's own periods: Corso's early career, his 'dark ages' and 'golden age' of Army research and development, and the decades of silence and disclosure that followed. The dark line shows which entry you are reading, and Play from here starts the video at that entry. Click a timestamp to play the video from the moment Gerb discusses that entry. Gerb does not tell the story in date order: he opens with the manuscript's release, for example, and comes back to the FBI file near the end. So while the video plays, the green line that shows where it has reached can jump backwards along the bar."
eras:
  - id: early
    label: "Early Career"
    from: 1942
    to: 1946
    summary: "Corso serves in Military Intelligence in wartime Europe, then commands the Counter Intelligence Corps in Rome."
  - id: dark
    label: "The Dark Ages of Army R&D"
    from: 1947
    to: 1957
    summary: "Corso's name for a disorganized, heavily compartmented decade in Army research. It opens with the body he says he saw at Fort Riley, and he spends it in Korea and on the staff of Eisenhower's National Security Council (NSC)."
  - id: golden
    label: "The Golden Age of Army R&D"
    from: 1958
    to: 1963
    summary: "Lieutenant General Arthur Trudeau brings all Army research and development (R&D) under one office and creates the Foreign Technology Division. According to Corso, the division seeds the Roswell material into industry."
    anchor: "the-armys-foreign-technology-division"
  - id: after
    label: "Silence and Disclosure"
    from: 1964
    summary: "Corso keeps his promise to Trudeau and stays silent for decades. He then publishes a book, swears an affidavit and dies. His manuscript and FBI file surface long afterwards."
hinges:
  - year: 1997
    label: "The Day After Roswell"
events:
  - date: "1942-02-23"
    title: "Corso enters the US Army"
    cue: 433
    summary: "Philip J. Corso began a 21-year Army career on 23 February 1942, serving first in Military Intelligence in Europe during World War II. The video stresses that few UFO witnesses can match his record of rank, stations and service."
    category: person
    significance: notable
    entities:
      - "Philip J. Corso"
  - date: "1945"
    title: "Chief of the Counter Intelligence Corps in Rome"
    cue: 446
    summary: "At the end of World War II Corso headed the US Counter Intelligence Corps (CIC) in Rome, arranged safe passage out of the city for Jewish refugees, and acted as personal emissary to Giovanni Battista Montini, the future Pope Paul VI."
    category: person
    significance: minor
    entities:
      - "Philip J. Corso"
  - date: "1947-07-06"
    title: "The body in the crate at Fort Riley"
    cue: 820
    summary: "In his 1998 affidavit Corso swore that on or about 6 July 1947, as post duty officer at Fort Riley, Kansas, he lifted the lid of one of five crates in the veterinary section and saw a four-foot non-human body floating in fluid. A sergeant told him the crates came by truck from an airfield in New Mexico and were bound for Wright-Patterson along Route 40. His service records place him at Fort Riley on that date."
    category: event
    significance: major
    entities:
      - "Fort Riley, Kansas"
  ...
  - date: "1947-07"
    title: "San Augustine crash"
    cue: 3113
    summary: "Besides Roswell, the only other recovery Corso's manuscript confirms by name is a July 1947 crash at San Augustine, New Mexico, of a saucer described as having no seams, joint lines, rivets or welds."
    category: event
    significance: minor
    entities:
      - "San Augustine, New Mexico"
  - date: "1950"
    title: "Korean War intelligence under MacArthur"
    cue: 465
    summary: "During the Korean War Corso served directly under General Douglas MacArthur as chief of the Special Projects Branch of Far East Command's Intelligence Division, investigating North Korean prisoner-of-war camps and the number of US and UN prisoners held in each."
    category: person
    significance: minor
    entities:
      - "Philip J. Corso"
  - date: "1953"
    title: "Staff of Eisenhower's National Security Council"
    cue: 497
    summary: "From 1953 to 1957 Corso served on the staff of President Eisenhower's National Security Council. His FOIA-released records list him on the Operations Coordinating Board, the covert-operations committee created under Executive Order 10483. He also claimed nine clearances above Top Secret, known only to Eisenhower and his superior C. D. Jackson."
    category: person
    significance: notable
    entities:
      - "Dwight D. Eisenhower"
      - "Philip J. Corso"
  - date: "1957"
    title: "The abandoned-mine encounter at White Sands"
    cue: 4617
    summary: "Near the end of Dawn of a New Age, Corso recounts that while commanding the Red Canyon ballistic missile firing range at White Sands in 1957-58 he sheltered from the heat in an abandoned mine and met a non-human being face to face. It asked him telepathically to lower the radar that was stopping its craft from leaving. When he asked what he would get in return, it answered 'a new world if you can take it'. Corso says he had the radar shut down."
    category: event
    significance: major
    entities:
      ...
      - "Philip J. Corso"
  - date: "1958"
    title: "Trudeau becomes Chief of Army R&D"
    cue: 1364
    summary: "In 1958 all Army research and development was pulled under one department, the Office of the Chief of Army R&D, headed by Lieutenant General Arthur Trudeau. Trudeau controlled its personnel, technical services, laboratories, installations and budget. Corso dates the 'golden age of Army R&D' from 1958 to 1963."
    category: organization
    significance: major
    entities:
      - "Arthur Trudeau"
  - date: "1958"
    title: "NASA's founding kills Project Horizon"
    cue: 1343
    summary: "The same year closed what Corso called the disorganized 'dark ages' of Army R&D. NASA was founded and ended the Army's Project Horizon moon-base plan. Atomic energy had been taken from the Army and handed to the Atomic Energy Commission, and the new Advanced Research Projects Agency (ARPA) often clashed with Army R&D."
    category: event
    significance: minor
    entities:
      - "NASA"
  ...
  - date: "1958-07"
    ...
    cue: 1476
    summary: "MITRE was established in 1958 by MIT Lincoln Laboratory staff working on the SAGE air-defense radar network. Gerb puts forward the thesis that this new federally funded research and development center (FFRDC) partly met the Army's need to seed recovered technology into US industry."
    category: organization
    significance: notable
    entities:
      - "MITRE Corporation"
  ...
  - date: "1958"
    title: "UFOs tracked on radar at Corso's missile sites"
    cue: 2567
    summary: "Corso said that twice while he commanded missile units, unidentified objects were tracked over New Mexico and over Germany at more than 3,000 mph, and that he was ordered to destroy the records and tapes. He went on to command the 71st Missile Battalion in Germany and serve as Inspector General of the Seventh Army."
    category: event
    significance: notable
    entities:
      - "Philip J. Corso"
  - date: "1960"
    title: "Chief of the Army Foreign Technology Division"
    cue: 2610
    summary: "In 1960 Trudeau brought Corso to the Pentagon as his special assistant and chief of a new Foreign Technology Division in the Office of the Chief of Army R&D. Of its four assigned subjects, the second was 'foreign intelligence and developments not of this world'. The video stresses it is not the Air Force's better-known division of the same name."
    category: organization
    significance: major
    entities:
      ...
      - "Philip J. Corso"
  - date: "1960"
    title: "Industry recruited into the seeding program"
    cue: 1518
    summary: "Around the division's creation, Corso says, the boards of the top 25 Fortune 500 companies were contacted, and contractors such as Bell Labs, universities, Army laboratories and Paperclip scientists were drawn into a program to exploit technologies of unknown origin. Artifacts went out disguised as normal R&D proposals and industry kept the patents. Corso put the budget at about $2 billion."
    category: program
    significance: major
    entities:
      - "Bell Labs"
      ...
      - "Operation Paperclip"
  - date: "1961"
    title: "Trudeau hands Corso the Roswell File"
    cue: 2830
    summary: "In 1961 Trudeau gave Corso a file drawer of field reports, autopsy reports and debris from the Roswell crash, including multicoloured 'wires', a chip, a laser instrument and fiber optics, and asked for a program. The autopsy reports, from Walter Reed, called the beings 'extraterrestrial biological entities' and matched the body Corso said he saw at Fort Riley 14 years earlier."
    category: document
    significance: major
    entities:
      - "Roswell Crash"
      ...
      - "Philip J. Corso"
  - date: "1961"
    title: "Air Force Foreign Technology Division formed"
    cue: 3605
    summary: "The Air Force's own Foreign Technology Division grew out of the Air Technical Intelligence Center at Wright-Patterson in 1961 under Air Force Systems Command and ran until 1991. The video separates it from Corso's Army office, which left almost no record, and notes Corso's claim that Projects Moon Dust and Blue Fly reported to the Air Force division."
    category: organization
    significance: notable
    entities:
  ...
  - date: "1962"
    ...
    entities:
      ...
      - "John B. Alexander"
  - date: "1963-03-01"
    title: "Corso retires from the Army"
    cue: 3505
    summary: "Corso retired on 1 March 1963, shortly after Trudeau. Near the end of his career, the video says, the division was working on lasers, anti-missile missiles and directed-energy weapons."
    category: person
    significance: notable
    entities:
      - "Philip J. Corso"
  - date: "1964"
    title: "FBI background check on Corso"
    cue: 4494
    summary: "A 1964-65 FBI background check, run when Corso was being considered for a post with a House subcommittee on immigration and national security, recorded unvalidated claims he had passed on, including that Lee Harvey Oswald was an FBI informant, and another agency's description of him as a 'parasite'. None of the files mention UFOs or his Army division."
    category: document
    significance: notable
    entities:
      - "Philip J. Corso"
  - date: "1968"
    title: "Mendel Rivers hearings and the squashed testimony"
    cue: 655
    summary: "According to Jacques Vallee's Forbidden Science, Eric Davis said George H. W. Bush told him Trudeau briefed him on legacy programs around the 1968 Mendel Rivers congressional hearings. Trudeau reportedly said 'his man Corso' had been asked to testify and could reveal alien hardware distributed to industrial labs, and the testimony was squashed as a result."
    category: event
    significance: notable
    entities:
      - "Eric Davis"
      ...
      - "Arthur Trudeau"
  - date: "1987-02"
    title: "DIA's UFO Working Group convenes"
    cue: 3884
    summary: "Corso later learned that in February 1987 Colonel Harold E. Phillips of the Defense Intelligence Agency chaired a 17-man UFO Working Group of generals, DIA scientists, NSA officials and CIA staff, including a technical team from the CIA's Science and Technology directorate. He said it was funded through Army INSCOM under Major General Albert Stubblebine."
    category: organization
    significance: notable
    entities:
      - "UFO Working Group"
  ...
  - date: "1993"
    ...
    entities:
      - "Philip J. Corso"
  - date: "1997"
    title: "The Day After Roswell published"
    cue: 4255
    summary: "Co-written with Bill Birnes and published for Roswell's 50th anniversary, the bestseller is 130 pages longer than Corso's manuscript and adds scenes he never wrote. Senator Strom Thurmond withdrew his foreword on learning the book was about UFOs, and Stanton Friedman said a colonel with a PhD had listed 92 false claims in it."
    category: document
    significance: major
    entities:
      - "Bill Burns"
      ...
      - "Stanton Friedman"
  - date: "1998-07"
    title: "The CAUS affidavit and Corso's death"
    cue: 777
    summary: "Shortly before Corso's death in July 1998 at age 83, Citizens Against UFO Secrecy published his sworn affidavit, signed for its attorney Peter Gersten to support a lawsuit against the Department of the Army. It covers the Fort Riley body, the 1961 Roswell File and the Walter Reed autopsy reports. Corso said he stayed silent until then because he had promised Trudeau not to speak until the general died."
    category: document
    significance: major
    entities:
      ...
      - "Arthur Trudeau"
  - date: "2003"
    title: "Dawn of a New Age released"
    cue: 278
    summary: "Corso's original notes and manuscript, which the video uses as its sole text, were released in Italy in 2003 and in the US in 2011. His son Philip Corso Jr. published them to correct the book, which his father had marked up in frustration."
    category: document
    significance: major
    entities:
      - "Philip Corso Jr."
...
- During World War II he served in Military Intelligence in Europe. At the war's end he headed the Counter Intelligence Corps in Rome. There he arranged safe passage for Jewish refugees and acted as emissary to Giovanni Battista Montini, the future Pope Paul VI.
- In the Korean War he worked directly under General Douglas MacArthur. He was chief of the Special Projects Branch of Far East Command's Intelligence Division and investigated prisoner-of-war camps. In 1992 he testified to the Senate Select Committee on POW/MIA Affairs about American soldiers abandoned in those camps.
- From 1953 to 1957 he served on the staff of [[Dwight D. Eisenhower|President Eisenhower]]'s [[National Security Council]].
...
## The Affidavit and the Fort Riley Body

::wiki-cue{t=777 video="_sv0Otxtcn4" video-title="Philip J. Corso - US Army UFO Technology Research & Development" entry-title="The CAUS affidavit"}
::

Shortly before Corso's death in July 1998, [[Citizens Against UFO Secrecy (CAUS)]] published an affidavit he had signed. He signed it for the group's attorney, Peter A. Gersten, to support a lawsuit against the Department of the Army. In it Corso swore to three things:

- He had been a member of Eisenhower's National Security Council and head of the Army's foreign technology desk.
- On or about 6 July 1947, at Fort Riley, he saw a four-foot non-human creature. It had four-fingered hands, thin legs, an oversized head shaped like a light bulb, almond-shaped eye sockets and a slit for a mouth.
- In 1961 he came into possession of a "Roswell file". Its autopsy reports, from Walter Reed hospital, described that same creature as an "extraterrestrial biological entity".

::wiki-cue{t=959 video="_sv0Otxtcn4" video-title="Philip J. Corso - US Army UFO Technology Research & Development" entry-title="Corso tells the Fort Riley story"}
::
...
caption: "Where the sergeant at Fort Riley told Corso the five trucks had come from and where they were going. Corso names only \"an airfield in New Mexico\", which he elsewhere ties to Roswell. The dashed line only joins the three places; it does not follow Route 40."
pins:
  ...
  - name: "Wright-Patterson Air Force Base"
    ...
    note: "Where the trucks were headed, by Route 40."
    cue: 1045
routes:
  - path: [1, 2, 3]
...
Corso described 1947 to 1958 as the disorganized "dark ages" of Army research and development. By 1958 the Army had lost ground on several fronts:

- [[NASA]] was founded that year and killed the Army's Project Horizon moon base.
- Atomic energy had been taken from the Army and given to the [[Atomic Energy Commission]].
- The new Advanced Research Projects Agency ([[DARPA|ARPA]]) often clashed with Army R&D.
...
root:
  name: "Arthur Trudeau"
  label: "Chief of Army R&D, 1958–1962"
  note: "Head of the Office of the Chief of Army R&D, with control of its personnel, technical services, labs, installations and budget."
  children:
    ...
    - name: "U.S. Army Foreign Technology Division"
      ...
      children:
        - name: "Army laboratories"
          label: "In-house labs"
          note: "The Night Vision Laboratory at Fort Belvoir and the Army's atomic labs."
        - name: "Bell Labs"
          label: "Industry partner"
          note: "Credited by Corso with advances in the transistor, laser and fiber optics."
        - name: "Sperry Rand"
          label: "Industry partner"
...
::wiki-cue{t=2610 video="_sv0Otxtcn4" video-title="Philip J. Corso - US Army UFO Technology Research & Development" entry-title="Corso becomes chief of the division"}
::

In 1960 Trudeau made Corso his special assistant and chief of the Foreign Technology Division. In Corso's words, he was to receive all reports on foreign technology, including foreign beings and events "not of this world". He led a team of US scientists and technicians, along with German scientists brought over under [[Operation Paperclip]]. Some of the items were known to come from crashed UFOs; others were educated guesses. Corso was given four subjects to track:

1. Foreign developments of this world.
2. Foreign intelligence and developments not of this world.
3. Serving as interim project officer on select R&D projects.
4. All other duties as special assistant to the Chief of R&D.

Subjects 1, 3 and 4 were ordinary work. The second, Corso wrote, was a different matter, since many experts felt the Army was helpless in the face of such technology. Corso acknowledged that he owed the post almost entirely to his close relationship with Trudeau. The two stayed friends after they retired. In the 1970s, when Trudeau was interviewed for the Army's oral history project, Corso was found with him in his kitchen.

### Two Foreign Technology Divisions
...
Gerb most wants viewers to take away that the division Corso ran belonged to the Army, not the Air Force.

::wiki-compare{video="_sv0Otxtcn4" video-title="Philip J. Corso - US Army UFO Technology Research & Development"}
---
caption: "The Army and the Air Force each had a Foreign Technology Division, and the video keeps them apart. Corso ran only the Army's."
attributeLabel: "Point"
subjects:
  - name: "U.S. Army Foreign Technology Division"
...
::wiki-cue{t=1518 video="_sv0Otxtcn4" video-title="Philip J. Corso - US Army UFO Technology Research & Development" entry-title="Industry recruited into the program"}
::

Corso says the Army had been exploiting recovered material since Roswell. Around the time his division was created, the Army took three steps:

- It contacted the boards of the top 25 companies on the Fortune 500 list.
- It strengthened its own laboratories.
- It brought Bell Labs, universities and Paperclip scientists together to exploit technologies of unknown origin.
...
| Technology | Corso's claim | What the video sets beside it |
|---|---|---|
...
- Corso mentions [[Sperry Rand]] many times; it should not be confused with the RAND Corporation. According to Trudeau's memoirs, he met often with its CEO and directors, among them General Douglas MacArthur. When Sperry Rand went defunct in 1986, many of its divisions passed to [[Honeywell]], [[Lockheed Martin]], Raytheon and [[Northrop Grumman]].
- In 1925 [[Bell Labs]] was placed under the shared ownership of [[Western Electric]] and [[AT&T]]. In 1949 President Truman gave AT&T management of [[Sandia National Laboratories]]. Gerb calls Sandia a "usual suspect". It appears in the Majestic documents, in [[Edgar Fouche]]'s account of the TR-3B, and in the disputed Interplanetary Phenomenon Unit papers.
- The [[MITRE Corporation]] was founded in 1958 by MIT Lincoln Laboratory staff who had built the SAGE air-defense network. Gerb puts forward the thesis that MITRE was created partly to meet the Army's need to seed recovered technology into industry.

## What the Roswell File Said

::wiki-cue{t=2830 video="_sv0Otxtcn4" video-title="Philip J. Corso - US Army UFO Technology Research & Development" entry-title="The Roswell File"}
::

In 1961 Trudeau called Corso in and gave him a file drawer. Corso was to go through it and come back with a program. Inside he found:

- multicoloured "wires"
- a chip
- a laser instrument
- fiber optics
- a paper-thin, high-strength metal
- the autopsy reports from Walter Reed

The reports matched what he had seen at Fort Riley 14 years before. They described decomposed bodies about four feet tall, with very large hearts and lungs and an unusual muscular structure. Their skin and bones were built to protect their organs from cosmic radiation or gravitational forces.

Corso and Trudeau's office noticed what the files left out. There was no food or water, no refrigeration, no toilet and no place to rest. The only medical equipment was what the recovery crew guessed was a first-aid kit. Corso's team drew several conclusions from this:

- The beings were clones, or at least expendable creatures made by some other intelligence for space travel.
- The craft was a reconnaissance vehicle meant to return to a mothership.
...
- spying on atomic installations
- interfering with missile and space tests
- interfering with exploration of the Moon and Mars
...
::wiki-cue{t=3884 video="_sv0Otxtcn4" video-title="Philip J. Corso - US Army UFO Technology Research & Development" entry-title="The UFO Working Group"}
::

Long after his service, Corso learned of a 17-member [[UFO Working Group]]. Colonel Harold E. Phillips of the [[Defense Intelligence Agency]] had chaired it since February 1987, and Corso said it was still active in 1993. The chart shows its make-up as Corso gives it.

::wiki-org-chart
---
root:
  name: "UFO Working Group"
  label: "Chaired by Col. Harold E. Phillips, DIA · Feb 1987"
  note: "17 original members, according to Corso's manuscript."
  children:
    - name: "Defense Intelligence Agency"
      label: "Chair and scientists"
    - name: "US Army"
      label: "One general and one colonel"
    - name: "US Air Force"
      label: "Three generals"
    - name: "NSA"
      label: "Three officials"
    - name: "CIA"
      label: "Two components"
      children:
        - name: "CIA Domestic Collection Division"
          label: "A supervisor"
        - name: "CIA Directorate of Science and Technology"
          label: "A technical team"
          note: "Eric Davis, Christopher Sharp and others say the government's 'UFO portfolio' is held here."
    - name: "Army INSCOM"
      label: "Funding, according to Corso"
      note: "Founded by Maj. Gen. Albert Stubblebine."
---
::
...
- [[Glenn Gaffney]], a director at the CIA Directorate of Science and Technology, is said to have stopped Lockheed Martin from passing UAP material to AAWSAP. [[Doug Wolfe]], a former deputy director there, helped create the [[CIA Office of Global Access]] in 2003. Journalist [[Christopher Sharp]] has accused that office of coordinating logistics for crash retrievals with [[JSOC (Joint Special Operations Command)|JSOC]].
- Gerb links the founder of Army INSCOM, [[Albert Stubblebine]], to legacy programs at Fort Huachuca, to an alleged attempt to pay off [[Steven Greer]], and to the alleged founding of the NSA's T.R.E.A.T. team. INSCOM's Intelligence Support Activity was handed to JSOC in 2003, the same year the Office of Global Access was created.
...
- He told John B. Alexander, [[George Knapp]] and Jacques Vallee.
...
- The being's physiology differs from that of the Fort Riley body.

At first he read the story as a dream or a parable, until he learned how many people Corso had told it to as fact. He sees it as part of a pattern in the UFO field, in which witnesses add dramatic experiences long after their first disclosures.
...
- John B. Alexander confirmed that the Army Foreign Technology Division existed and then vanished.
...
- Corso swore in a 1998 affidavit that on or about 6 July 1947 he saw a four-foot non-human body at Fort Riley, Kansas, where he was post duty officer. The body was in one of five crates being trucked from New Mexico to Wright-Patterson. His service records place him at Fort Riley on that date.
- In 1961 Trudeau allegedly gave Corso the "Roswell File" of field reports, debris and Walter Reed autopsy reports. The reports called the beings "extraterrestrial biological entities" and matched the body Corso saw in 1947.
- Trudeau created the Army Foreign Technology Division, and Corso headed it from 1960. It was assigned "foreign intelligence and developments not of this world". It is a different body from the Air Force's Foreign Technology Division, and apart from Corso's records it left almost no trace.
- Corso said the division seeded recovered artifacts into industry as ordinary R&D proposals, with a budget of about $2 billion, and let companies keep the patents. He credited this program with:
  - night vision
  - fiber optics
  ...
  - the laser
- Corso's team concluded that the Roswell beings were clones built for space travel, and that they formed part of their craft's guidance system. This inspired Army research into controlling aircraft and missiles with brain waves.
- According to Vallee's *Forbidden Science*, George H. W. Bush made two claims to Eric Davis. First, Corso could not have mistaken Nazi hardware for recovered technology. Second, a conversation with Trudeau about Corso's planned 1968 congressional testimony led to that testimony being squashed.
- Corso said the Soviets ran their own parallel recovery program. In 1993 he obtained a list of materials the Soviets had recovered, from a KGB general.
- Corso wrote that a 17-member UFO Working Group, chaired by DIA Colonel Harold E. Phillips, began meeting in February 1987. It included a technical team from the CIA's Directorate of Science and Technology and was funded through Army INSCOM.
- Corso claimed that at White Sands in 1957–58 a non-human being asked him telepathically to lower the radar holding its craft down. It promised "a new world if you can take it", and he complied.
- *The Day After Roswell* adds scenes and claims that are absent from Corso's manuscript *Dawn of a New Age*. Corso's son published the manuscript to correct the book. Critics' objections, including Stanton Friedman's list of 92 false claims, are aimed mainly at the book.

## Sources

- [YouTube](https://www.youtube.com/watch?v=_sv0Otxtcn4) — UAP Gerb

## Related Pages

- **People**: [[Philip J. Corso]], [[Arthur Trudeau]], [[Philip Corso Jr.]], [[Bill Burns]], [[John B. Alexander]], [[Jacques Vallee]], [[Eric Davis]], [[Daniel Sheehan]], [[George Knapp]], [[Stanton Friedman]], [[John Greenewald]], [[Strom Thurmond]], [[Hermann Oberth]], [[Leonard Stringfield]], [[Albert Stubblebine]], [[Doug Wolfe]], [[Glenn Gaffney]], [[Christopher Sharp]], [[David Grusch]], [[Brad Sorenson]], [[Edgar Fouche]], [[Dwight D. Eisenhower]]
