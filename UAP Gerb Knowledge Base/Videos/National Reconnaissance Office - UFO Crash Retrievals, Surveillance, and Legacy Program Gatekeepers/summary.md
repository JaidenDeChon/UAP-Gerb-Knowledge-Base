...
events:
  ...
  - date: "1953-01"
    ...
    cue: 6014
    summary: "The evidence put before the January 1953 Robertson Panel included Projects Grudge and Blue Book, Battelle's Project Stork, Project Twinkle and an 'outline of investigation of UFOs proposed by Kirtland Air Force Base, Project Pounce'. Gerb counts the panel among the milestones of an 80-year official disinformation campaign."
    category: document
    significance: minor
    entities:
      - "Robertson Panel"
  ...
  - date: "1963"
    ...
    cue: 5392
    summary: "Colonel Steve Wilson claimed that in 1963, as a captain with a tactical fighter squadron at Wright-Patterson, he was assigned to Majestic 12, whose purpose was to control UFO surveillance, interdiction, retrieval and analysis. Gerb urges caution, citing Kevin Randle's critiques of Wilson's record."
    category: person
    significance: minor
    entities:
      - "Steve Wilson"
  ...
  - date: "1983-03"
    ...
    cue: 1838
    summary: "Collins claimed the Talon Gold and Teal Ruby projects resulted directly from satellite photos of orbiting craft of unknown origin. Gerb believes Reagan's SDI program, which absorbed them, back-channeled funds to legacy programs and hid offensive anti-UFO capabilities."
    category: program
    significance: minor
    entities:
  ...
  - date: "1992-09"
    ...
    cue: 1332
    summary: "Director Martin C. Faga officially declassified the NRO in 1992, and Programs A to D were replaced by functional directorates. Senate Select Committee on Intelligence scrutiny of the newly public agency's finances began the same year, which Gerb suggests may have prompted legacy programs to fortify themselves."
    category: organization
    significance: major
    entities:
      - "Martin C. Faga"
  ...
  - date: "2003"
    ...
    cue: 4212
    summary: "CIA DS&T deputy director Doug Wolfe founded the Office of Global Access, which Gerb alleges acts as logistics coordinator and 'glue' for crash retrievals outside the continental United States. Wolfe had spent 16 years in the CIA component of the NRO."
    category: organization
    significance: major
    entities:
  ...
  - date: "2003"
    ...
    cue: 9346
    summary: "Future AARO director Sean Kirkpatrick served as a CIA program manager assigned to the NRO from 2003 to 2005 and as a DS&T staff scientist from 2005 to 2007, one of the windows in which Gerb suspects he was first exposed to legacy programs."
    category: person
    significance: minor
    entities:
      - "Sean Kirkpatrick"
  ...
  - date: "2012"
    ...
    cue: 6884
    summary: "Airman Dylan Borland testified that a light at Langley AFB became a silent black equilateral triangle about 100 feet away, with a gold, lava-like fluid flowing over it. Gerb reads this as an electro-optic cloaking system derived from non-human craft on a human-built airframe."
    category: event
    significance: notable
    entities:
      - "Dylan Borland"
  ...
  - date: "2015"
    ...
    cue: 2322
    summary: "In 2015 the NRO stated it had no UFO documentation, that the topic was 'outside of the scope of NRO responsibilities', and that past searches had located no records. Gerb notes that its 2021 contributions to the UAP Task Force contradict this."
    category: document
    significance: minor
    entities:
      - "NRO (National Reconnaissance Office)"
  - date: "2016-07-27"
    ...
    cue: 8809
    summary: "A GAO report shows that the Under Secretary for Acquisition, Technology and Logistics and the ODNI's acquisition, technology and facilities office share milestone decision authority over NRO acquisitions. Gerb treats these two offices as a nexus of legacy-program gatekeepers."
    category: document
    significance: minor
    entities:
  ...
  - date: "2020"
    ...
    cue: 8735
    summary: "As Under Secretary for Acquisition and Sustainment, Ellen Lord established the corporate portfolio program, which Gerb calls a major legacy-program milestone because it gave defense-industrial firms access to DoD executives, FFRDCs and SAP portfolio managers."
    category: policy
    significance: notable
    entities:
      - "Ellen Lord"
  ...
  - date: "2021-05-07"
    ...
    cue: 3522
    summary: "FOIA records published by The Black Vault show that NGA, NASIC, DIA and the NRO consulted the UAP Task Force in May 2021 on collection assets. Gerb notes David Grusch was a liaison to the task force for the NRO and NGA at the time."
    category: document
    significance: minor
    entities:
      - "The Black Vault"
  ...
  - date: "2022"
    ...
    cue: 9758
    summary: "Asked by RGH_UFOs about Inman's referral, Heinman did not deny it but said he was 'a long way and quite a few years' from the area being researched, then stopped replying. He has not answered Gerb either."
    category: event
    significance: notable
    entities:
      - "Everett Heinman"
  ...
  - date: "2024-10"
    ...
    cue: 1437
    summary: "NRO director Chris Scolese said the office had launched 100 satellites between June 2023 and December 2024 under its proliferated-architecture strategy. Gerb believes classified systems in orbit may be double the acknowledged number."
    category: program
    significance: minor
    entities:
      - "NRO (National Reconnaissance Office)"
  - date: "2025"
    title: "Gerb's retrieval-team witness"
    cue: 4633
    summary: "After a year of trying, Gerb reached a man who says he served for years on a 21st-century crash retrieval rapid reaction team at the Nevada Test Site. His briefing binders were marked 'Joint Operations Task Force, NRO', and his DoD badge carried an NRO watermark and a Q hologram. He described an egg-shaped craft in a Central or South American jungle."
    category: event
    significance: major
    entities:
...
root:
  ...
  note: "Per Gerb, the siloed authority behind a 'Joint Operations Task Force, NRO'."
  children:
    ...
    - name: "Direct action"
      ...
      children:
        - name: "Delta detachment"
          ...
          note: "First on scene, per Gerb's witness."
    - name: "Logistics"
...
The oldest account: an oval craft 30 to 40 feet across, "similar to an egg with the shell cracked and yolk still inside", with a multi-layered honeycomb skin, a forward bulkhead and a shiny sphere at its centre behind a second bulkhead. Gerb says this layering is what lends Collins credibility.
::
::
...
rows:
  ...
  - attribute: "DOE teams in MOPP gear"
    cells:
      ...
      - { text: "Yes, DOE-embroidered; Gerb says NEST", mark: same, cue: 4441 }
      - "—"
      - "—"
---
::
...
The NRO was founded to see into denied airspace, and Gerb argues it would be the "vanguard" agency for flying craft built from non-human technology. His reasoning is that satellites only collect, while a craft with no radar or visual signature could loiter hundreds of feet from a target, recover a crash before an adversary, or place satellites in orbit without a detectable launch. He ties this to Grusch's description of a secret "cold war" with peer adversaries to master non-human technology, which suggests such vehicles are either still in development or used only rarely.

His main witness is [[Edgar Fouche]], who in 1998 described the TR-3B: a triangle whose reverse-engineered magnetic field disruptor, developed by Sandia and Livermore, cut its mass by 89 percent. Fouche said it was built by Lockheed, Boeing, Northrop and Teledyne Ryan, managed by the NRO, NSA and CIA, and flown by those same agencies. He said it used electrochromatic coatings to change colour and disappear. Gerb says signature management of this kind is a "crown jewel" that legacy programs have sought to copy from non-human craft. He links it to [[Dylan Borland]]'s sworn account of a 100-foot black triangle at Langley in 2012 ([[Borland's Triangular Craft Sighting]]), which "manifested" around a light and was covered by a flowing gold, lava-like field. When asked whether the *technology* was American, Borland would say only that he would have to answer in a SCIF. Gerb concludes that the airframe was human-built but its electro-optic cloaking was derived from non-human craft, and asks whether such a triangle flies for the CIA, NSA and NRO.
...
entries:
  ...
  - name: "Ellen Lord"
    ...
    note: "Established the 2020 corporate portfolio program, which Gerb calls a major legacy-program milestone."
  - name: "Doug Wolfe"
  ...
  - name: "Donald M. Kerr"
    ...
    note: "A resume Gerb calls exactly that of a high-level legacy member: SAIC, EG&G, Los Alamos, DS&T and MITRE."
  - name: "Everett Heinman"
...
Gerb asks the current administration to follow up on all thirteen.

## One Program or Many

In a closing segment recorded after *[[The Age of Disclosure]]* premiered on 21 November 2025, Gerb sets his model against the one the documentary presents, in which [[Luis Elizondo]] and [[Eric Davis]] describe a single legacy program run from the CIA DS&T.
