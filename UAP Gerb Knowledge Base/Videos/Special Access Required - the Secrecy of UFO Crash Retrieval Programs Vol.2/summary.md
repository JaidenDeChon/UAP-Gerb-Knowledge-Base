...
events:
  - date: "1947-07"
    ...
    cue: 1232
    summary: "The video recaps Part One: after the 1947 National Security Act created the National Security Council, Truman is said to have relegated control of the UFO portfolio to the NSC. Gerb argues the program's legal skeleton has been White House and NSC-run for most of its life."
    category: policy
  ...
  - date: "1952"
    ...
    cue: 7812
    summary: "Project Blue Book took over from Project Grudge in 1952. That year Ruppelt recorded a filmed briefing, Flying Saucer Talk (file AF-ATIC-film 0352), which Representative Eric Burlison has named as held at MIT Lincoln Laboratory. Gerb asks why a Lincoln Lab film was never handed over to the National Archives."
    category: document
    significance: notable
    entities:
      - "Edward J. Ruppelt"
  ...
  - date: "1953-11"
    ...
    cue: 2535
    summary: "Eisenhower's EO 10501 removed the restricted designation and ushered in ad hoc protections such as top secret codeword access, which Gerb calls the start of the idea of special access."
    category: policy
    significance: minor
    entities:
      - "Dwight D. Eisenhower"
  - date: "1954-03"
    ...
    cue: 1246
    summary: "Eisenhower's 5412 Committee Special Group, set up to oversee covert action, is said to have become the UFO program's control group, which Gerb calls Majestic 12. Grusch has said five people on the NSC were involved at one time, and the 5412 group had five members. Because the work sat under a covert-action body, Gerb argues it was covert action from the start."
    category: policy
    significance: major
    entities:
      - "Dwight D. Eisenhower"
  ...
  - date: "1954-08"
    ...
    cue: 1059
    summary: "The Atomic Energy Act of 1954 created statutory categories such as Restricted Data and special nuclear material, outside the executive-order system and beyond unilateral presidential declassification. Citing Grusch, Gerb says the vague Section 51 definition has been used to transclassify non-human material as nuclear secrets."
    category: policy
    significance: major
    entities:
  ...
  - date: "1964"
    ...
    cue: 5162
    summary: "The 5412 Special Group, which Gerb says operated as the control group from 1954 to 1964, was succeeded by the 303 Committee (1964 to 1970). After 1970 the line of control is, in Gerb's words, a bit of an unknown until 1994."
  ...
  - date: "1969"
    ...
    cue: 7883
    summary: "Edward Condon's 1969 study ended Project Blue Book using, Gerb says, the same debunking playbook as the Robertson Panel. J. Allen Hynek stated the committee ignored key evidence."
    category: event
    significance: notable
    entities:
      - "Condon Committee"
  ...
  - date: "1991"
    ...
    cue: 5616
    summary: "Gerb places the covert action statute now codified at 50 U.S.C. 3093 in the early 1990s, after 10 U.S.C. 119 in the late 1980s. With both on the books, he argues, legacy programs had to find a route that avoided Title 10 and Title 50 reporting."
    category: policy
    significance: notable
    entities:
  ...
  - date: "1997"
    ...
    cue: 3431
    summary: "Per the Wilson-Davis notes, Vice Admiral Thomas Wilson, then deputy director of the DIA, was pointed by General H. Marshal Ward to a special records group in the acquisition office run by Paul Kaminski. The index contained zero budget information, and the Senior Review Group told Wilson to drop the matter. Gerb calls the missing budget the most important detail in the notes."
    category: document
    significance: major
    entities:
      - "Wilson-Davis Memo"
  ...
  - date: "c. 2003"
    ...
    cue: 6699
    summary: "The earliest mention of DARPA SID Gerb could find is a routing line on a 2003 DARPA Information Processing Techniques Office document. He calls SID a legacy program-protection office and alleges former directors took part in serious crimes to silence whistleblowers."
    category: organization
    significance: minor
    entities:
  ...
  - date: "2007"
    ...
    cue: 3693
    summary: "Clapper served as Under Secretary of Defense for Intelligence from 2007 to 2010, then as Director of National Intelligence from 2010 to 2017. Gerb calls him the closest thing to a Cheney-level legacy boss and alleges he gave cover to ATIP."
    category: person
    significance: notable
    entities:
      - "James Clapper"
  ...
  - date: "2008"
    ...
    cue: 8490
    summary: "The Defense Intelligence Agency's AAWSAP ran from 2008 to 2012 on a $22 million budget sponsored by Senator Harry Reid. Citing Grusch, Gerb says one of its purposes was to receive the Kona Blue transfer of UFO materials from Lockheed Martin."
    category: program
    significance: notable
    entities:
      - "AAWSAP"
  ...
  - date: "2009-01"
    ...
    cue: 206
    summary: "Gerb calls Cheney the last mob boss to control the whole legacy portfolio across its silos. If progress on the programs stalled, he says, it was after 2009."
    category: event
    significance: notable
    entities:
      - "Dick Cheney"
  - date: "2009"
    ...
    cue: 8518
    summary: "ATIP's main years are given as about 2009 to 2017. Gerb describes it as an unfunded informal working group, not a program, and alleges it was cover for National Security Council activities under Clapper, a way to talk about the onion outside the onion."
    category: program
    significance: major
    entities:
  ...
  - date: "2010"
    ...
    cue: 3057
    summary: "The video dates Kona Blue, a proposed Department of Homeland Security special access program, to 2010. It was meant to let Lockheed Martin pass UFO materials to AAWSAP, and Gerb uses its two-word name as an example of how a SAP nickname works."
    category: program
    significance: minor
    entities:
      - "Kona Blue"
  ...
  - date: "2012"
    ...
    cue: 6904
    summary: "System High has worked with SID since 2012 and in 2022 won its third consecutive five-year multi-security-services contract. Gerb notes that Rob Howe, the company's president until 2025, previously managed special activities at Northrop Grumman and was a program security officer for Air Force acquisition."
    category: organization
    significance: minor
    entities:
      - "System High"
  ...
  - date: "2017"
    ...
    cue: 9231
    summary: "Elizondo joined Tom DeLonge's To The Stars Academy in 2017, which Gerb frames as the vehicle for a slow-disclosure campaign with John Podesta and others to position Hillary Clinton as the disclosure president. He asks whether Elizondo told DeLonge about Immaculate Constellation."
    category: event
    significance: notable
    entities:
      - "Luis Elizondo"
  ...
  - date: "2017"
    ...
    cue: 11194
    summary: "Citing Grusch, Gerb says Immaculate Constellation was run out of the National Security Council from about 2017, and suspects it was an intelligence SAP."
    category: program
    significance: notable
    entities:
  ...
  - date: "2018"
    ...
    cue: 6843
    summary: "Highnam was DARPA's deputy and acting director from 2018 to 2022, after running IARPA and research at the NGA. He is now a principal deputy assistant secretary of defense for critical technologies under USD(R&E), the chain that runs down to SID. Gerb names him as a senior legacy program figure."
    category: person
    significance: notable
    entities:
      - "Peter Highnam"
  ...
  - date: "2022"
    ...
    cue: 7900
    summary: "The planned UAP Joint Program Office was reshaped into AARO under USD(I&S) Ronald Moultrie, with Sean Kirkpatrick hired as director through David M. Taylor. Gerb calls AARO the latest step in the Robertson-Condon playbook and a honeypot for whistleblowers."
    category: organization
    significance: major
    entities:
      - "AARO"
  ...
  - date: "2024-11"
    ...
    cue: 8884
    summary: "Asked at the 2024 UAP hearing whether he was read into crash-retrieval programs, Elizondo said he had signed documents three years earlier restricting what he could say about crash retrievals. Gerb reads his discomfort as a sign of a forced change of posture after Grusch."
    category: event
    significance: minor
    entities:
      - "Luis Elizondo"
      ...
      - label: "No reporting"
        steps:
          - text: "No statutory reporting"
            note: "Nothing owed under Title 10 or Title 50; consistent, Gerb argues, with the zero-budget record Admiral Wilson found in 1997."
            cue: 5497
      ...
      - label: "No budget"
        steps:
          ...
          - via: "Paid for off the books"
            ...
            note: "Haircuts across other programs (Gerb guesses the Forest Service and BLM among them), contractor IRAD overcharging, self-funding cutouts such as E-Systems, and what Grusch calls a criminal enterprise."
            cue: 9632
---
::
...
entries:
  - name: "Air Force Office of Special Investigations"
    ...
    note: "Guards the Air Force's most sensitive SAPs. Covered only briefly, having featured in Gerb's Hidden Wing video. He names former executive director Terry Phillips and his successor Lee M. Russ as 'attack dogs' for the legacy architecture."
  - name: "DARPA Security and Intelligence Directorate (SID)"
    role: "DARPA's program protection element"
    note: "Its program security representatives support every tier from fundamental research to SAPs, 'frequently for technologies that exist nowhere else.' Traced to at least 2003. Gerb alleges former directors took part in serious crimes, including wet works, and urges Congress to question them under oath."
...
entries:
  ...
  - name: "Lee M. Russ"
    ...
    note: "Phillips's successor, who Gerb says 'picked up right where Phillips left off.' He would not be surprised if documents tie Russ to UFO narrative shaping."
  - name: "Peter Highnam"
  ...
  - name: "Paul Kaminski"
    ...
    note: "Ran the office where Wilson found the zero-budget record in 1997. A senior SAPOC member and later a MITRE board member, whom Gerb says he knows was 'very senior' in the portfolio."
  - name: "Marshal Ward"
    role: "Former DoD SAPCO director and SAPOC executive secretary"
    note: "Allegedly told Admiral Wilson the special records group sat in the acquisition office. Gerb counts him, with Dawn Dunlop, among past DoD SAPCO directors who were 'almost certainly' legacy personnel."
...
- The 1997 record Admiral [[Thomas Wilson]] reportedly found in the acquisition office contained zero budget information, which Gerb treats as the decisive clue to the content-only mechanism and the most important detail in the [[Wilson-Davis Memo]].
