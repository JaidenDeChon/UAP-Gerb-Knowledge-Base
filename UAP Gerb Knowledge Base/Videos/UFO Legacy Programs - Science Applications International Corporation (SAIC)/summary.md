...
---
help: "The video is arranged by Gerb's five topics rather than by date, so this timeline collects its dated events in one place, in three periods of SAIC's history. The bar above the list runs from the earliest entry to the latest, with a coloured mark for each; taller marks are major entries. Click the bar to jump to a year. Play from here starts the video at the entry you are reading, and Follow video scrolls the list along with it. Because Gerb moves between topics, the green line that shows where the video is will jump back and forth along the bar. Click a timestamp to play the video from that moment. Every timestamp here was checked against the video's captions."
eras:
  - id: founding
    label: "Founding and Star Wars"
    from: 1969
    to: 1990
    summary: "Founder J. Robert Beyster fills his employee-owned 'body shop' with generals and spies, and SAIC becomes the leading contractor on the Strategic Defense Initiative."
    anchor: "washingtons-shadow"
  - id: gatekeepers
    label: "Stargate and the gatekeepers"
    from: 1991
    to: 2012
    summary: "SAIC takes over Project Stargate, former SAIC men sit on the restructured committee that oversees secret special access programs, and Denise McKenzie, Thomas Wilson and Randy Anderson come forward."
    anchor: "the-gatekeepers"
  - id: succession
    label: "Split and succession"
    from: 2013
    summary: "The company splits into SAIC and Leidos and keeps buying others, a former SAIC scientist leads AARO, and large SAIC contracts at Naval Surface Warfare Center Crane vanish from its website."
    anchor: "nswc-crane-and-the-off-world-technologies-division"
hinges:
  - year: 1994
    label: "SAP oversight restructured"
events:
  - date: "1961"
  ...
  - date: "1965"
    title: "William Raborn heads the CIA"
    cue: 2599
    summary: "Vice Admiral William F. Raborn, who led development of the Polaris submarine-launched missile before retiring from the Navy in 1963, headed US intelligence from 1965 to 1966 and later held senior SAIC roles. John P. Craven said the Sand Dollar seabed retrieval program was hidden inside another secret program within Polaris."
    category: person
    significance: minor
    entities:
      - "William F. Raborn"
      ...
      - "Project Sanddollar"
  - date: "1969-02-03"
    title: "J. Robert Beyster founds SAIC"
    cue: 438
    summary: "Nuclear physicist J. Robert Beyster, formerly of Westinghouse's Atomic Power Division, Los Alamos and General Atomics, founded Science Applications as one of the first employee-owned companies. Its stock plan let it stack its board and staff with generals, admirals, spies and cabinet officers; its first contracts, from the Defense Atomic Support Agency, calculated the output of nuclear devices."
  ...
  - date: "1971-07-18"
    title: "Steve Wilson's first ARV flight, with Inman present"
    cue: 796
    summary: "Colonel Steve Wilson claimed the first successful flight of a man-made anti-gravity Alien Reproduction Vehicle took place on 18 July 1971 with Admiral Bobby Ray Inman, later an SAIC board member, in attendance."
    category: event
    significance: minor
    entities:
      - "Steve Wilson"
  ...
  - date: "1977-01-04"
    title: "Decision Science Applications (DSAI) founded"
    cue: 677
    summary: "DSAI was founded in Virginia as an employee-owned technical services company. Steve Wilson claimed DSAI and SAIC were one and the same, that its board held directors of UFO black budget divisions, that Inman ran it, and that it was paramount to UFO programs hidden in the Strategic Defense Initiative."
    category: organization
    ...
    entities:
      ...
      - "Bobby Ray Inman"
  - date: "1977"
    title: "US anomalous cognition programs begin (Project Stargate)"
    cue: 6166
    summary: "Acknowledged US research into anomalous cognition began in 1977 as a joint Army, DIA, CIA and SRI International program under a series of code names, including Gondola Wish, Grill Flame, Center Lane and Sun Streak, with Major General Albert Stubblebine a key sponsor."
    category: program
    significance: notable
    entities:
      - "Project Stargate"
      ...
      - "Army INSCOM"
  - date: "1978"
    title: "SAIC leads in particle beam weapons"
    cue: 4056
    summary: "From 1978 and throughout Star Wars, SAIC was the 'best represented contractor' for particle beam weapons, one of the main technologies of the Strategic Defense Initiative."
    category: program
    significance: minor
    entities:
      - "SAIC"
  ...
  - date: "1983"
    ...
    entities:
      ...
      - "Steve Wilson"
  - date: "1983"
    title: "Hudson Valley boomerang sightings begin"
    cue: 4308
    summary: "Stealth aircraft researcher Joseph Jones claimed in 2013 that Project Brilliant Buzzard, an SDI-born, Boeing-contracted airborne surveillance program, flew a huge boomerang craft responsible for some 25,000 Hudson Valley sightings between 1983 and 1989."
    category: program
    significance: minor
    entities:
      ...
      - "Boeing"
  - date: "1985"
    title: "Oke Shannon's notes: approach Don Kerr for 'influence and money'"
    cue: 2771
    summary: "At the 1985 Advanced Theoretical Physics working group at BDM's secure facility in McLean, Virginia, supervised by John B. Alexander a year after Albert Stubblebine joined BDM, Los Alamos special projects manager Oke Shannon noted underwater UFO hotspots, a group that destroys UFO information, and a plan to approach Donald Kerr for influence and money."
    category: document
    significance: notable
    entities:
      - "Oak Shannon"
  ...
  - date: "1987"
    ...
    entities:
      - "SAIC"
  - date: "1988"
    title: "SAIC's Electric Propulsion Study for the Astronautics Laboratory"
    cue: 5471
    summary: "SAIC began a study, released in August 1990, for the Air Force Astronautics Laboratory at Edwards Air Force Base, written by Dennis Cravens with Los Alamos's Ferris Williams. It discussed the Biefeld-Brown effect and a five-dimensional unification of fields, and suggested rotating mercury-filled cylinders for anti-gravity, the method Edgar Fouché later tied to the TR-3B."
    category: document
    significance: major
    entities:
      ...
      - "Los Alamos National Laboratory"
  - date: "1989-09-29"
    title: "Moriches Bay, Long Island crash retrieval"
    cue: 4374
    summary: "Leonard Stringfield's 1991 Status Report 6 relays an anonymous Air Force intelligence colonel's claim that a UFO was downed by a US Star Wars weapon off Long Island's south shore and retrieved from the dunes. A Brookhaven scientist called Dr. Nick said the weapon was deployed by Brookhaven National Laboratory, which later worked with SAIC on SDI lethality programs."
    category: event
    significance: notable
    entities:
      - "Leonard Stringfield"
  ...
  - date: "1991"
    ...
    entities:
      ...
      - "SAIC"
  - date: "1992"
    title: "Denise McKenzie finds contracts with no activity at SAIC La Jolla"
    cue: 3360
    summary: "Recruited from a San Diego fabric store by a woman called Sophia, administrative assistant Denise McKenzie found that multi-million-dollar military contract files at SAIC's La Jolla campus held only form letters saying the work was 'being worked on'. She was ordered to forget the matter; she later found Sophia's photo, under another first name, among deceased agents on a CIA website."
    category: event
    significance: major
    entities:
      - "Denise McKenzie"
      - "SAIC"
  - date: "1992"
    title: "Aldric Saucier wins whistleblower protection over SDI"
    cue: 3957
    summary: "Scientist Aldric Saucier had alleged since 1986 that SDI mismanaged and wasted research money and misled Congress; dismissed and investigated by the FBI, he was given whistleblower protection in 1992 after a review by Secretary of Defense Dick Cheney. The same year, a former SAIC executive said in a sworn deposition that 'mischarging' had become institutionalized within the company."
    category: event
    significance: notable
    entities:
      - "Dick Cheney"
      - "Strategic Defense Initiative (SDI)"
  - date: "1993"
    title: "Donald Kerr joins SAIC"
    cue: 2742
    summary: "Former Los Alamos director (1979-1985) and EG&G president (1989-1992) Donald M. Kerr joined SAIC as a corporate executive vice president and director, before becoming CIA deputy director for science and technology, NRO director and principal deputy DNI."
    category: person
    significance: notable
    entities:
      - "Donald M. Kerr"
  ...
  - date: "1997"
    ...
    cue: 2440
    summary: "Naval Reserve Commander Will Miller, a senior analyst for SAIC, attended a 1997 meeting with Vice Admiral Thomas Wilson and Steven Greer. In emails he later named 'civilian DoD contractors, BDM, SAIC, Boeing, Lockheed' as possible keepers of the keys."
    category: event
    significance: minor
    entities:
      - "Will Miller"
      ...
      - "Steven Greer"
  - date: "1998"
    title: "Edgar Fouché's DARC and SDI claims"
    cue: 4164
    summary: "Edgar Fouché said the Defense Advanced Research Center near Groom Lake was flush with SDI money in the mid-1980s, that up to 35% of SDI funding was siphoned to UFO black programs, and that SDI money built the TR-3B."
    category: document
    significance: notable
    entities:
      - "Edgar Fouche"
      ...
      - "Strategic Defense Initiative (SDI)"
  - date: "1998"
    title: "David Kay tells the Senate Saddam has WMD"
    cue: 1433
    summary: "David Kay, director of SAIC's Center for Counterterrorism Technology and Analysis, testified to the Senate Armed Services Committee that Saddam Hussein remained in power with weapons of mass destruction. SAIC executives later staffed the commission that examined the intelligence failure."
    category: event
    significance: minor
    entities:
      - "SAIC"
  - date: "1999"
    title: "SAIC and Northrop Grumman form AMSEC"
    cue: 5316
    summary: "SAIC and Northrop Grumman's Newport News Shipbuilding formed AMSEC LLC, a naval engineering joint venture that grew from $100 million in 2000 revenue to $500 million by 2007 and later held naval surface warfare center contracts."
    category: organization
    significance: notable
    entities:
      - "SAIC"
  ...
  - date: "2001-03"
    ...
    entities:
      ...
      - "Steven Greer"
  - date: "2001"
    title: "Eric Davis's Teleportation Physics Study"
    cue: 5799
    summary: "Eric Davis's 2001-2003 study for the Air Force Research Laboratory devotes a section to 'p-teleportation', drawing on the remote viewing program run at SRI with NSA, CIA, DIA and INSCOM sponsorship that later moved to SAIC."
    category: document
    significance: notable
    entities:
      - "Eric Davis"
  ...
  - date: "2002"
    ...
    entities:
      ...
      - "SAPOC (Special Access Program Oversight Committee)"
  - date: "2002"
    title: "NSA picks an SAIC consortium for Trailblazer"
    cue: 4624
    summary: "An SAIC-led consortium with Boeing and Booz Allen Hamilton won the NSA's Trailblazer data-analysis contract, worth over $280 million and billions within four years. NSA whistleblowers including William Binney alleged fraud and waste; the 2005 DoD Inspector General report was over 90% redacted, and SAIC then won the $361 million ExecuteLocus follow-on."
    category: program
    significance: notable
    entities:
      - "NSA"
  ...
  - date: "2003"
    ...
    cue: 2877
    summary: "The Office of Global Access, which Gerb and Christopher Sharp accuse of foreign UFO crash retrievals with the Joint Special Operations Command (JSOC), was set up in the CIA's Directorate of Science and Technology while former SAIC vice president Donald Kerr was its deputy director (2001-2005). The video dates the office to 2002 and 2003 in different places."
    category: organization
    significance: notable
    entities:
  ...
  - date: "2005"
    title: "Burglary at SAIC La Jolla"
    cue: 4774
    summary: "A never-solved break-in at SAIC's guarded La Jolla site took one desktop and four laptops from 13 private offices, with personal data on thousands of past and present employees, many of them former CIA, NSA and Pentagon officials."
    category: event
    significance: minor
    entities:
      - "SAIC"
  - date: "2010"
    title: "$351 million NSWC Crane contract for JSOC support"
    cue: 7161
    summary: "SAIC won a $351 million contract to provide technical engineering services to Naval Surface Warfare Center Crane in support of its joint special operations response department."
    category: program
    significance: notable
    entities:
  ...
  - date: "2013-09-27"
    ...
    entities:
      ...
      - "Leidos"
  - date: "2016-08-16"
    title: "Leidos takes Lockheed Martin's IS&GS business"
    cue: 1061
    summary: "Leidos merged with Lockheed Martin's Information Systems and Global Solutions business, acquiring it for $5 billion."
    category: organization
    significance: notable
    entities:
      - "Leidos"
      - "Lockheed Martin"
  - date: "2018"
    title: "SAIC buys Engility"
    cue: 995
    summary: "SAIC purchased Engility, spun off from L-3 Communications in 2012, for $2.5 billion, so that DSAI's assets ended up at both SAIC and L3Harris."
    category: organization
    significance: notable
    entities:
      - "SAIC"
  ...
  - date: "2020"
    ...
    cue: 1349
    summary: "Under Secretary of Defense for Acquisition and Sustainment Ellen Lord set up the Corporate Portfolio Program, giving eligible contractors such as SAIC access to DoD executives, scientists and special access programs. She joined SAIC's advisory board in July 2021."
    category: policy
    significance: notable
    entities:
      - "Ellen Lord"
  ...
  - date: "2020"
    ...
    entities:
      ...
      - "SAIC"
  - date: "2022"
    title: "AARO contracts SAND Corp"
    cue: 1747
    summary: "Under Sean Kirkpatrick, AARO took DoD contracts with SAND Corp, a company specializing in plugging whistleblower leaks."
    category: organization
    significance: notable
    entities:
      - "AARO"
      ...
      - "Sean Kirkpatrick"
  - date: "2023-01-31"
    title: "Kirkpatrick briefs SpaceCom on 'UAP response and recovery'"
    cue: 2020
    summary: "FOIA documents from US Space Command, recovered by researcher TAG_OM in September 2024, record a Kirkpatrick briefing to senior DoD attendees on 'UAP response and recovery and material transfer'. Kirkpatrick had led an intelligence community task force for SpaceCom in 2018-2019."
    category: document
    significance: major
    entities:
      - "Sean Kirkpatrick"
      - "AARO"
  - date: "2023"
    title: "$249 million Crane weapons instrumentation IDIQ"
    cue: 7140
    summary: "A $249 million indefinite delivery, indefinite quantity contract for SAIC to support Crane's weapons division instrumentation platform vanished from SAIC's website around January 2024."
    category: program
    significance: notable
    entities:
      - "Naval Surface Warfare Center Crane"
      - "SAIC"
  - date: "2023-12"
    title: "Kirkpatrick joins Oak Ridge National Laboratory"
    cue: 2039
    summary: "Kirkpatrick became chief technology officer for defense and intelligence programs at Oak Ridge, a DOE FFRDC administered by Battelle."
    category: person
    significance: notable
    entities:
      - "Sean Kirkpatrick"
      ...
      - "Battelle Memorial Institute"
  - date: "2025-01-01"
    title: "MITRE subcontracts Kirkpatrick's Nonlinear Solutions"
    cue: 1946
    summary: "Kirkpatrick's firm Nonlinear Solutions LLC was subcontracted by MITRE under an IDIQ contract for its National Security Engineering Center FFRDC serving US Space Command. SAIC had studied 'turbulence and nonlinear solutions' for the DOE in 1987."
    category: organization
    significance: notable
    entities:
      - "Sean Kirkpatrick"
      - "MITRE Corporation"
  - date: "2025-06-05"
    title: "Matt Brown points to Amentum's Pax River hangars"
    cue: 6675
    summary: "Immaculate Constellation whistleblower Matt Brown tweeted that UFO materials or craft were stored in special project hangars at Naval Air Station Patuxent River owned by Amentum, a company SAIC partners with in a joint venture that won over $1.3 billion in IDIQ contracts by 2020."
    category: event
    significance: notable
    entities:
      - "Matt Brown"
...
The video opens with clips that place SAIC at the center of UFO lore: a speaker naming it, with Lockheed Martin and Northrop, among the "consortium of companies" said to build alien reproduction vehicles, and a *Jane's Defence Weekly* postscript on an SAIC electric propulsion study for the Air Force Astronautics Laboratory that tested theories linking electromagnetism and gravity, "in simplified terms an anti-gravity propulsion system". It also plays a speaker who calls it "highly unethical" for the government to "hand receipt" recovered material to cleared contractors, which then sell insight back to the government for profit.
...
root:
  ...
  children:
    - name: Leidos
      ...
      note: "SAIC spun off a $4 billion company that kept the SAIC name, because conflict-of-interest rules in federal acquisition regulations kept the larger company from bidding on new work."
      children:
        - name: "Lockheed Martin Information Systems and Global Solutions"
          label: "Acquired for $5 billion, 16 August 2016"
    ...
    - name: AMSEC LLC
      label: "Joint venture with Northrop Grumman, 1999"
      note: "Owned with Northrop Grumman's Newport News Shipbuilding; naval engineering revenue grew from $100 million in 2000 to $500 million by 2007."
    - name: Research and Development Solutions LLC
      label: "Joint venture with EG&G and Parsons, 2004"
      note: "Formed 15 September 2004 and soon given a $217 million contract at the DOE's National Energy Technology Laboratory; now defunct."
    - name: "SAIC–Amentum joint venture"
      label: "Joint venture with Amentum"
      note: "Won more than $1.3 billion in IDIQ contracts as recently as 2020."
---
::
...
---
kind: custody
label: "How DSAI's assets reached SAIC"
caption: "DSAI's business, traced from its founding in 1977 through mergers, sales and spin-offs to SAIC, following posts by a Reddit researcher that have since been deleted."
steps:
...
root:
  ...
  label: "Restructured with a Senior Review Group, 1994"
  note: "Per Wilson, the structure that kept UFO legacy programs from even a three-star admiral and DIA director."
  children:
    - name: Bill Perry
...
entries:
  ...
  - name: Bill Perry
    role: Deputy Secretary, then Secretary of Defense
    note: "Restructured SAP oversight in 1994; the video says he once served on SAIC's board."
  - name: Bobby Ray Inman
    role: Admiral; NSA director, CIA deputy director, SAIC chairman
...
A clip from David Grusch's 2023 congressional testimony opens the section: asked how the programs are funded, he says he has specific knowledge of misappropriated funds, and agrees that contractors overcharge and route money to programs "through something called IRAD" ([[Independent Research and Development (IRAD)|independent research and development]]).
...
---
caption: "Denise McKenzie's claim that SAIC's contract files held nothing but form letters, and the accounts the video sets beside it."
claim:
...
stats:
  - value: "$280M"
    label: NSA Trailblazer contract, 2002
    hint: "Grew to billions within four years"
  - value: "$361M"
    label: ExecuteLocus contract
    hint: "Awarded after Trailblazer failed"
  - value: "$124M"
    label: FBI Virtual Case File
    hint: "Written off after three years"
  - value: "1987–1995"
    label: Flat panel display fraud
    hint: "Fake prototypes on an Air Force contract"
---
::

The NSA chose an SAIC-led consortium with Boeing and Booz Allen Hamilton in 2002 to build Trailblazer, a system for analyzing mass communications data; Bobby Ray Inman worked on it. NSA employees, including William Binney, complained to the DoD Inspector General of fraud, waste and abuse when a working prototype already existed, and were harassed and raided by the FBI. The 2005 Inspector General report was more than 90% redacted, and SAIC was immediately awarded ExecuteLocus, a revised Trailblazer. The FBI's Virtual Case File was called the "most highly publicized software failure in history". *Vanity Fair* observed that if SAIC can't deliver, "new contracts will simply be drawn up". In 2005 SAIC's guarded La Jolla site suffered a never-solved burglary of one desktop and four laptops from 13 private offices, with personal data on thousands of employees, many of them former CIA, NSA and Pentagon officials: "quite the targeted theft". SAIC was also charged in the early 2000s with submitting "false and fraudulent statements" of expected costs and profits for waste cleanup at Air Force bases.
...
Remote viewing or clairvoyance: "a form of information transfer in which all known sensorial stimuli are absent". SAIC reported that it and earlier programs **were able to verify** its existence.
::
::wiki-panel{title="Anomalous perturbation"}
Psychokinesis: "a form of interaction with matter in which all known physical mechanisms are absent". SAIC reported that it **was not able to verify** its existence.
::
::
...
stats:
  - value: "$351M"
    label: SAIC contract, 2010
    hint: "Support for Crane's joint special operations response department"
  - value: "$133M"
    label: SAIC contract, 2020
    hint: "Maneuver, Surveillance and Engagement division; deleted from SAIC's site"
  - value: "$249M"
    label: SAIC IDIQ, 2023
    hint: "Weapons division instrumentation; vanished around January 2024"
  - value: "2,489"
    label: Crane's contracting workforce
---
::

He places the Off-World Technologies Division within Crane's organization this way:
    ...
    - name: "Special Warfare and Expeditionary Systems Division (JX)"
      ...
      children:
        - name: "Weapon Systems Division (JXN)"
          ...
          note: "Includes a 24 May 2023 contract to Woods Hole for research and development of expeditionary systems."
        - name: "Maneuver, Surveillance and Engagement Systems Division (JXW)"
          label: "$133 million SAIC contract, 2020"
...
- [YouTube](https://www.youtube.com/watch?v=9p99lTsC7wQ) - UAP Gerb
...
- **Operations**: [[Project Sanddollar]], [[AATIP (Advanced Aerospace Threat Identification Program)]], [[Kona Blue]]
- **Events**: [[Hudson Valley UFO Flap]]
