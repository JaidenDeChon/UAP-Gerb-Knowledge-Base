...
stats:
  - value: "5,400 G"
    ...
    hint: "Its drop from 28,000 ft to sea level in ~78 s"
  - value: "1,100 GW"
    label: "Power the Tic Tac needed"
    hint: "For an assumed 1,000 kg craft"
  - value: "269,000 mph"
    label: "Japan Airlines 1628 object"
    hint: "Knuth's estimate of its top speed"
  - value: "19 km/s"
    label: "Saucer speeds on radar"
    hint: "Hermann Oberth's 1954 figure, from 50+ measurements"
---
::

## Overview

In this video Gerb walks through the physics of UAP as presented by [[Kevin Knuth]], a physics professor at the [[University of Albany|University at Albany]], vice president of the field research group [[UAP-X]] and a research affiliate of [[Avi Loeb]]'s [[Galileo Project]]. It covers two pieces of Knuth's work: the paper "Estimating Flight Characteristics of Anomalous Unidentified Aerial Vehicles", published in the journal *Entropy* on 25 September 2019 with [[Robert M. Powell]] and [[Peter Reali]], and Knuth's November 2023 talk at the [[Sol Foundation]] (the [[Sol Foundation 2023 Presentation by Kevin Knuth]]), where the speakers also included [[Karl Nell]], [[David Grusch]] and [[Gary Nolan]]. Gerb addresses the video to his "engineering and physics brethren" and says the paper has inspired him since it appeared. He presents Knuth as the one accomplished academic who publicly takes the physics of UFOs seriously while the rest of academia scoffs.

The video centres on a set of numbers. From the [[2004 Nimitz UAP Encounter (Tic Tac)|2004 Nimitz "Tic Tac" encounter]], Knuth derives an acceleration of about 5,400 G for a drop from 28,000 feet to sea level in some 78 seconds, and a power of about 1,100 gigawatts, which Gerb puts at ten times the total nuclear output of the United States. Stopping should then have released as much energy as 250 Tomahawk cruise missiles, but nothing was seen. Knuth adds [[Hermann Oberth]]'s 1954 report of radar-measured speeds of 19 km/s, the 1968 egg-shaped object at [[Minot Air Force Base, North Dakota|Minot Air Force Base]] (209 G, Mach 12) and the [[1986 Japan Airlines UFO Incident|1986 Japan Airlines Flight 1628]] object (about 269,000 mph). He then estimates the light UAP give off and the strength of their electric and magnetic fields, and ends with objects that move between air and water: the [[Aguadilla Puerto Rico Trans-Medium UAP Incident|Aguadilla]] footage and the [[1987 HMNZS Southland USO Incident|HMNZS Southland]] case.

Knuth himself is cautious. He opens by saying he is skeptical of people who assume they have seen an alien spacecraft, and that unfamiliar engineering can look a lot like anomalous physics. Gerb draws a firmer conclusion at the end: since Knuth lists transmedium cases from before the Second World War, and no known technology survives thousands of G, the claim that UAP are simply foreign adversary technology does not hold.

## Chronology

The video does not take the cases in date order. Put in order below, the cases Knuth and Gerb cite span eight decades, a span Gerb leans on in his closing argument.

::wiki-timeline{video="inyw4Vfu7Z0" video-title="The Physics of UFOs– Dr. Kevin Knuth"}
---
help: "The bar above the list covers the eight decades these cases span. Each case or publication the video cites has a coloured mark on it, and taller marks are major entries. Click the bar to jump to a year. The dark line shows which entry you are reading. Play from here starts the video at that entry, and once it is playing a green line shows which entry Gerb has reached. Gerb takes the cases out of date order, so the green line jumps back and forth along the bar. Turn on Follow video to have the list scroll along with the video; scrolling yourself turns it off. Click a timestamp to play the video from that moment. Every timestamp here was checked against the captions."
events:
  - date: "1943"
    title: "Japan foo fighters"
    summary: "One of the seven images on Knuth's opening slide. Gerb skips it and the 2016 Mosul orb as already discussed to death."
    category: event
    cue: 260
  - date: "1951-02"
  ...
  - date: "1953"
    ...
    summary: "Gerb says this regulation was brought in to restrict UFO reporting and keep reports from Blue Book, Congress and the public. The declassified Minot report of 1968 was filed under it."
    category: policy
    entities:
  ...
  - date: "1968"
    ...
    summary: "An egg-shaped object with skin like molten lava kept about 3 miles from a descending B-52, then closed 2 miles in one 3-second radar sweep, which works out to 209 G and Mach 12 (9,200 mph). The case was reported under Regulation 200-2 and never reached the Blue Book files."
    category: event
    significance: major
    entities:
  ...
  - date: "1976-09-19"
    ...
    summary: "Major Parviz Jafari's avionics were scrambled as an orb detached from the object he was vectored toward. Knuth uses the case as an example of electronics failing near a craft."
    category: event
    entities:
  ...
  - date: "2004-11-14"
    ...
    summary: "The Tic Tac dropped from 28,000 feet to sea level in about 78 seconds. That works out to about 5,400 G, and about 1,100 GW of power for an assumed 1,000 kg craft."
    category: event
    significance: major
    entities:
  ...
  - date: "2016"
    title: "Mosul orb"
    summary: "An orb over Mosul, Iraq, supplied by Jeremy Corbell. It is another image on Knuth's slide that Gerb skips."
    category: event
    cue: 260
  - date: "2019-09-25"
  ...
  - date: "2023-11"
    ...
    summary: "Knuth spoke on the physics of UAP at the Sol Foundation symposium, where Karl Nell, David Grusch and Gary Nolan also spoke. This talk is the subject of the video."
    category: event
    significance: major
    entities:
...
Knuth began his Sol Foundation talk by saying he was skeptical on two counts: of people who assume they have witnessed an alien spacecraft, and of physicists who deny that craft could defy known physics. It is surprising, he said, for academia to insist "we know our physics" when research still cannot unify general relativity and quantum mechanics. Engineering is the art of using physics to work around problems, so unfamiliar engineering can look a lot like anomalous physics, and he is not ready to leap to anomalous physics at the first anomaly. Like [[Karl Nell]], he also took issue with the ambiguity of the term "UAP": some of these objects, he said, are observed and described very well. [The closing section](#the-foreign-adversary-question) sets out the positions he answers next to Gerb's.

## The Seven Photographs

To present UAP as a class of phenomena, Knuth showed a slide of seven photographs, a selection Gerb calls very deliberate. Gerb skips two, the 2016 Mosul orb supplied by Jeremy Corbell and the 1943 Japanese foo fighters, as already discussed to death, and describes the other five. In two of these, the people who took the photograph did not see the object. The two Wisconsin series, taken four years apart, show what Gerb calls an almost identical craft with different lights.

::wiki-compare{video="inyw4Vfu7Z0" video-title="The Physics of UFOs– Dr. Kevin Knuth"}
---
caption: "The five photographs from Knuth's slide that Gerb describes, oldest first. The Same and Differs markers appear only on the two Wisconsin series, the one pair Gerb compares."
...
Knuth then turned to the [[Five UAP Characteristics (AATIP)|five characteristics of UAP]], six if biological effects are counted, as outlined by [[Luis Elizondo]]: instantaneous acceleration, hypersonic velocity without signatures, low observability, transmedium travel and positive lift without visible propulsion. Gerb is glad to see them mentioned. Knuth concentrated on the first two together, and on the case Gerb says he always reaches for when people call UAP foreign technology.

### The Nimitz Tic Tac

During the [[2004 Nimitz UAP Encounter (Tic Tac)|Tic Tac]]'s drop from 28,000 feet to sea level in about 78 seconds, the craft experienced an estimated 5,400 G. Knuth gives "around 5,000 G" as the lower bound and notes that no person, and little equipment, would survive it. Gerb sets the figure against the limits of anything built:
...
stats:
  ...
  - value: "~100 G"
    ...
    hint: "The most they take before breaking apart"
  - value: "5,400 G"
    label: "The Tic Tac"
    hint: "Knuth's estimate"
---
::

Knuth then works out the power and energy involved. With no known mass for the Tic Tac, he picks a deliberately low one, about a tenth of a similarly sized F-18, which weighs about 10,000 kg. The steps below follow his argument.
...
steps:
  - text: "A drop of 28,000 ft in about 78 s"
    note: "The craft reached about 42,000 mph partway down."
    cue: 476
  ...
  - via: "with an assumed mass of 1,000 kg, needs"
    ...
    note: "Gerb puts this at ten times the total nuclear output of the United States."
    cue: 515
  ...
  - via: "yet observers saw"
    ...
    note: "Knuth calls this the energy-deposition puzzle: where did the energy come from, and where did it go?"
    cue: 866
---
::

Knuth draws one more conclusion: a craft that sustained accelerations like these could reach a large fraction of the speed of light and cross interstellar distances at relativistic speed. The video quotes his conclusion that these objects have the flight characteristics needed for interstellar travel and "would make excellent interstellar craft".

### Oberth's radar speeds

Knuth next cited a source that was new to Gerb: a 1954 lecture on flying saucers by [[Hermann Oberth]], the German father of modern rocketry and mentor of the [[Operation Paperclip]] scientist [[Wernher von Braun]]. Oberth reported that saucers had been clocked at 19 km/s, about 42,000 mph or Mach 55. He stressed that he was not relying on three or four measurements: more than 50 radar measurements existed in USAF and US Navy data. The same year he wrote in *American Weekly* that flying saucers are real spaceships from another solar system, possibly crewed by observers who may have been studying Earth for centuries, and that they might fly by "distorting the gravitational field".

### Minot, Japan Airlines and the four cases side by side

Knuth also cited a little-known 1968 encounter at [[Minot Air Force Base, North Dakota|Minot Air Force Base]], a nuclear-weapons base like [[Malmstrom Air Force Base|Malmstrom]]. According to base personnel, an egg-shaped object with skin described as molten lava held about 3 miles off a descending B-52, then closed 2 miles within a single 3-second radar sweep. The lava-like skin reminds Gerb of an egg-shaped crashed craft whose skin showed the [[Mother of Pearl Effect|mother-of-pearl effect]]. He also notes that the declassified report was filed under [[USAF Regulation 200-2]], so the case never reached the [[Project Blue Book]] files or the public despite being a multi-sensor military detection. For the [[1986 Japan Airlines UFO Incident|Japan Airlines]] case, Gerb replays footage from his iceberg series: at about 5 p.m. on 17 November 1986, Captain [[Captain Kenju Terauchi|Kenju Terauchi]] and two crew watched a craft and two smaller lights orbit their 747.

::wiki-compare{video="inyw4Vfu7Z0" video-title="The Physics of UFOs– Dr. Kevin Knuth"}
---
caption: "The four encounters Knuth puts numbers to, as Gerb relays them. An Unknown marker (dashed outline) means the video gives no figure."
...
The [[1987 HMNZS Southland USO Incident]], new to Gerb, took place north of New Zealand in February 1987; the account comes from radar operator and seaman [[David Barnett]]. An object 150 feet wide and 800 feet long, which also seemed not to interact with the water, closed a 20-kilometre gap on the frigate in under half a minute. That means a minimum speed of about 1,492 mph and an average of 4.5 G. It then passed underneath and killed all the ship's power, draining its batteries.
...
The video ends with the conclusion Gerb draws from Knuth's numbers. Below are the three positions the video argues against: two that Knuth answers at the start of his talk, and one that Gerb answers at the end of the video.
...
Gerb closes by saying he has been infatuated with the paper's data since 2019, to the point of asking Knuth for a job on LinkedIn. Putting G-forces on the Tic Tac, he says, turns the anomalous craft Elizondo describes into measurable quantities. His favourite cases from the talk are the Nimitz and Japan Airlines encounters.
...
entries:
  - name: Kevin Knuth
    ...
    note: "The video is about his work. He was lead author of the 2019 flight-characteristics paper and spoke at the Sol Foundation in November 2023."
  ...
  - name: Peter Reali
    role: Co-author of the 2019 paper
    note: "Third author of the paper, which Entropy published on 25 September 2019."
  - name: Hermann Oberth
  ...
  - name: Parviz Jafari
    ...
    note: "His avionics were scrambled as an orb approached his jet over Tehran in 1976. Knuth uses the case as an example of the fields around UAP."
  - name: David Barnett
