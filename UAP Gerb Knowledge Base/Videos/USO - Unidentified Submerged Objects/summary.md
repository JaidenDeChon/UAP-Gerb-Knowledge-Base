...
events:
  ...
  - date: "1954"
    ...
    cue: 313
    summary: "The Joint Army Navy Air Force Publication directive 146c required both airborne and waterborne UFO sightings to be reported through service communications instructions for vital intelligence and maritime intelligence sightings. Civilians and pilots were barred from discussing officially reported sightings under the Communications Act of 1934 and espionage laws, with prison and a $10,000 fine for violators. Gerb dates the 'dark ages of UFO reporting' from these three rules."
    category: policy
    significance: major
    entities:
      - "JANAP 146c"
  - date: "1955"
    ...
    cue: 1362
    summary: "The only record Gerb found of submarines carrying balloons is a joint Navy-CIA document on test balloon launches from submarines in 1955, which he cites against the theory that the 1971 USS Trepang photographs show a balloon training exercise."
    category: document
    significance: minor
    entities:
      - "CIA"
...
Gerb's history begins in the early days of [[Project Blue Book]]. In 1951 USAF Major [[Dewey Fett]], a sitting Blue Book member, launched [[Project Interloper]] with the help of the US Navy to investigate both aerial and undersea UAP. Although Fett served on Blue Book, Interloper was run as an extra-governmental investigation, which made it exempt from Freedom of Information Act requests; Gerb is unsure whether that was directed by other parts of the government. Interloper briefed the CIA in 1953, but its findings never reached Congress or the public.
...
With the official record thinned out, Gerb says the story "has to rely on claims" of USO studies and experiences.
...
In Gerb's account, 2022 is the year USO talk "became much louder" and reached the public.
  ...
  - title: "Balloon training exercise"
    ...
    responses:
      ...
      - by: ["Dean Reynolds Sackett", "John Klika"]
        stance: challenges
        text: "Reached by investigator Steve Murillo, Sackett said he saw nothing unusual and \"only saw ice\"; Klika said he did not know what the pictures showed. For Gerb, these two statements \"essentially kill\" this theory."
        cue: 1386
  - title: "Fata Morgana"
...
entries:
  ...
  - name: Edward J. Ruppelt
    ...
    note: "His statement that AFOIN ran a fuller UFO investigation in parallel with Blue Book is Gerb's basis for reading AFOIN-X-SG as a secret special group."
  - name: Mark Dantonio
...
- The March 1971 USS Trepang photographs remain unresolved; Gerb considers the balloon-training explanation undercut by the witnesses' statements and the lack of records, leaving hoax or genuine, and agrees with John Greenewald that the one altered image does not discredit the rest.
