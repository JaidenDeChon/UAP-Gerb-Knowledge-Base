...
events:
  - date: "1951"
    ...
    entities:
      ...
      - "Project Blue Book"
  - date: "1952-04-24"
    title: "AFOIN-X-SG forwards nine submarine contact reports"
    cue: 190
    summary: "A letter from AFOIN-X-SG to the Air Technical Intelligence Center, addressed to a Colonel Dunn, attached nine reports of submarine contacts with flying discs, compiled with the Office of Naval Intelligence. The reports are unavailable. The host reads 'SG' as a special group of the Air Force Office of Intelligence, citing Edward J. Ruppelt's statement that AFOIN ran a fuller UFO investigation parallel to Blue Book, and judges it likely one of the government's real secret UFO investigation groups."
    category: document
    significance: major
    entities:
  ...
  - date: "1952"
    ...
    entities:
      ...
      - "Office of Naval Intelligence"
  - date: "1953"
    title: "Interloper briefs the CIA"
    cue: 105
    summary: "Project Interloper briefed the CIA in 1953, but according to the video its findings never reached Congress or the American public."
    category: event
    significance: notable
    entities:
      - "Project Interloper"
      - "CIA"
  - date: "1953"
    title: "USAF Regulation 200-2 routes UFO reports to ATIC"
    cue: 357
    summary: "The Air Force regulation required all official UFO reports to go to the Air Technical Intelligence Center rather than to Project Blue Book. The video counts it as the first of three rules that took maritime and military sightings out of public view."
    category: policy
    significance: notable
    entities:
      ...
      - "Project Blue Book"
  - date: "1954-01-23"
    title: "Navy issues OPNAV 3820"
    cue: 369
    summary: "The Office of the Chief of Naval Operations directive required UAP sightings, called 'flying object reports', to go to the directors of ATIC, USAF Intelligence and Naval Intelligence. A copy appears in Donald Keyhoe's The Flying Saucer Conspiracy, and it cites JANAP 146c directly."
    category: policy
    significance: major
    entities:
      - "OPNAV 3820"
      - "JANAP 146c"
  - date: "1954"
    title: "JANAP 146c brings waterborne sightings under reporting rules"
    cue: 313
    summary: "The Joint Army Navy Air Force Publication directive 146c required both airborne and waterborne UFO sightings to be reported through service communications instructions for vital intelligence and maritime intelligence sightings. Civilians and pilots were barred from discussing officially reported sightings under the Communications Act of 1934 and espionage laws, with prison and a $10,000 fine for violators. The host dates the 'dark ages of UFO reporting' from these three rules."
    category: policy
    significance: major
    entities:
      - "JANAP 146c"
  - date: "1955"
    title: "Navy and CIA test balloon launches from submarines"
    cue: 1362
    summary: "The only record the host found of submarines carrying balloons is a joint Navy-CIA document on test balloon launches from submarines in 1955, which he cites against the theory that the 1971 USS Trepang photographs show a balloon training exercise."
    category: document
    significance: minor
    entities:
      - "CIA"
  ...
  - date: "1971-03"
    title: "USS Trepang photographs"
    cue: 1270
    summary: "Photographs said to have been taken through the periscope of the attack submarine USS Trepang between Iceland and Jan Mayen Island show triangular, cigar-shaped and possibly egg-shaped objects hovering over, entering or leaving the water. Commanding officer Dean Reynolds Sackett and the alleged spotter John Klika both said they did not know what the pictures showed."
    category: event
    significance: major
    entities:
      - "USS Trepang USO Photographs"
  - date: "1979"
    title: "CUFON's FOIA requests on the special group denied"
    cue: 293
    summary: "The Computer UFO Network filed Freedom of Information Act requests for information on the AFOIN special group. All were denied under executive order on national security grounds."
    category: document
    significance: notable
  - date: "1985"
    title: "Advanced Theoretical Working Group notes an Argentine USO hotspot"
    cue: 543
    summary: "Oak Shannon, a former manager of special projects at Los Alamos and a Department of Energy nuclear physicist, attended the Advanced Theoretical Working Group at BDM International's McLean secure facility, classified under DOE controls. His notes, published in 2022, list UFO hotspots such as Mount Hayes, Alaska, and record that the Navy had intelligence on an underwater UFO hotspot near Golfo San Matias off Argentina."
    category: document
    significance: major
    entities:
      - "Oak Shannon"
  ...
  - date: "1985"
    ...
    entities:
      ...
      - "Steven Greer"
  - date: "1991"
    title: "Black triangle rises beside the USS Nimitz"
    cue: 1197
    summary: "Petty Officer Kevin Thomas claimed that, left on deck after the Nimitz was ordered to darken and clear decks, he saw a huge black triangle nearly a kilometre long lift silently out of the ocean, with no water dripping from it, and shoot vertically into the sky. Men in civilian clothes questioned him aboard the next day. The host says he could not locate Thomas's service record."
    category: event
    significance: major
    entities:
      - "USS Nimitz 1991 USO Encounter"
  - date: "2004-11"
    ...
    entities:
      ...
      - "David Fravor"
  - date: "2010"
    title: "Tic Tac dives beneath the USS Carl Vinson"
    cue: 1150
    summary: "Off the coast of Haiti, Petty Officer John Bowman saw a white Tic Tac-shaped object about 20 feet long appear in the water below the flight deck and dart into the depths, its forward end collapsing in on itself as it went. His supervising officer told him not to file a report."
    category: event
    significance: major
    entities:
      - "USS Carl Vinson USO Sighting"
  - date: "2013"
    title: "Aguadilla object enters and leaves the Atlantic"
    cue: 886
    summary: "Filmed by US Customs and Border Protection thermal imaging, the object flew at 40 to 120 mph over three minutes, entered and left the Atlantic without significant deceleration, reached 95 mph underwater and split in two. As quoted in Gallaudet's paper, the Scientific Coalition for UAP Studies concluded no known human-made technology has those capabilities."
    category: event
    significance: major
    entities:
  ...
  - date: "2017"
    ...
    entities:
      - "Mark Dantonio"
  - date: "2022"
    title: "John Ramirez on an ONR-WINPAC materials pipeline"
    cue: 594
    summary: "Former CIA operative John Ramirez said he had heard of a relationship between the Office of Naval Research and the CIA's Weapons Intelligence, Nonproliferation and Arms Control Center (WINPAC) under which USO materials were recovered and transferred to the CIA."
    category: event
    significance: notable
    entities:
      - "John Ramirez"
  ...
  - date: "2022"
    ...
    entities:
      ...
      - "Luis Elizondo"
  - date: "2023-11"
    title: "Gallaudet on the Sol Foundation panel"
    cue: 636
    summary: "Retired Rear Admiral Timothy Gallaudet, former NOAA administrator, spoke on the Sol Foundation's November 2023 panel, where he described receiving the GIMBAL and GOFAST videos before they were removed from his inbox. The video calls him the most credible figure to speak on USOs."
    category: event
    significance: notable
    entities:
      - "Rear Admiral Timothy Gallaudet"
      - "Sol Foundation"
  - date: "2024-03"
    title: "AARO's historical report omits every USO case"
    cue: 851
    summary: "The video, following Gallaudet, notes that AARO's Historical Report Volume 1 makes no reference to any USO case or maritime whistleblower."
    category: document
    significance: notable
    entities:
      ...
      - "AARO"
  - date: "2024"
    title: "Gallaudet's white paper 'Beneath the Surface'"
    cue: 728
    summary: "Published by the Sol Foundation, Gallaudet's paper calls for USO study to become a national research priority, citing the DoD's 'concerning non-reaction' to unidentified objects entering US waters, congressional definitions of UAP as trans-medium vehicles, and the Tic Tac, Aguadilla and Shelburne Harbor cases."
    category: document
    significance: major
    entities:
      - "Beneath the Surface (Gallaudet White Paper)"
      - "Rear Admiral Timothy Gallaudet"
      - "Sol Foundation"
---
::

## The 1950s Paper Trail

### Project Interloper (1951)

The host's history begins in the early days of [[Project Blue Book]]. In 1951 USAF Major [[Dewey Fett]], a sitting Blue Book member, launched [[Project Interloper]] with the help of the US Navy to investigate both aerial and undersea UAP. Although Fett served on Blue Book, Interloper was run as an extra-governmental investigation, which made it exempt from Freedom of Information Act requests; the host is unsure whether that was directed by other parts of the government. Interloper briefed the CIA in 1953, but its findings never reached Congress or the public.

Only three case files survive: cases 26, 27 and 28. Case 26 covers US Navy Lieutenant George P. Williams and his nine-man Navy Fleet Logistics Air Wing crew, who watched a trans-medium object leave the ocean and cross the sky between Keflavik, Iceland and Newfoundland. First mistaken for a ship, it rose from beneath the clouds, approached the aircraft at a "terrifying closing rate", hovered off the port side and then left at alarming speed. It was elliptical or cigar-shaped, at least 200 feet long, with a red-orange glow around its edge. Case 27, not a USO case, records a South African Airways Constellation flying from London to Johannesburg whose pilots saw a silvery disc deep inside the crater of an extinct volcano near the Kenyan border, which then shot straight up and out of sight.

### AFOIN-X-SG and the Office of Naval Intelligence (1952)
...
In the host's account, 2022 is the year USO talk "became much louder" and reached the public.

### Oak Shannon's notes (1985, published 2022)

[[Oak Shannon]], a former manager of special projects at [[Los Alamos National Laboratory]] and Department of Energy nuclear physicist, is best known on the channel for confirming the [[Wilson-Davis Memo]]. In 2022 he published notes from the 1985 Advanced Theoretical Working Group, held at [[BDM International]]'s secure facility in McLean and classified under DOE controls. Alongside UFO hotspots such as Mount Hayes, Alaska, Shannon wrote that the Navy had intelligence on an underwater UFO hotspot near Golfo San Matías, off the coast of Argentina.

### John Ramirez and WINPAC (2022)

Former CIA operative [[John Ramirez]] said in 2022 that he had heard of a relationship between the [[Office of Naval Research]] and the CIA's Office of Scientific and Weapons Research, later WINPAC (the Weapons Intelligence, Nonproliferation and Arms Control Center), under which USO materials were recovered and transferred to the CIA. The host saves the CIA side of this for a future video.

## Rear Admiral Timothy Gallaudet and *Beneath the Surface*

The host calls [[Rear Admiral Timothy Gallaudet]] "absolutely the most credible figure" to speak on USOs. A retired US Navy rear admiral, Gallaudet was Assistant Secretary of Commerce for Oceans and Atmosphere and administrator of the [[National Oceanic and Atmospheric Administration (NOAA)]]. On the [[Sol Foundation]]'s November 2023 panel, he said he was mystified that more ocean scientists are not curious about what he called the story of the century happening in the water. He also described receiving the GIMBAL and GOFAST videos and having them mysteriously removed from his inbox, and has since tweeted about a Southern California anomaly, possibly USO-related, being scrubbed from Google Earth.

In a NewsNation interview with [[Ross Coulthart]], Gallaudet said Earth is being visited by non-human intelligence whose technology and intentions are not understood. Asked whether he was stating categorically that NHI are real, he said "absolutely" and that it is about time to disclose that contact.

His 2024 Sol Foundation white paper, [[Beneath the Surface (Gallaudet White Paper)|*Beneath the Surface: We May Learn More About UAP by Looking in the Ocean*]], treats USO study as both a maritime security issue and an unprecedented scientific opportunity that should be raised to a national research priority. It cites the Defense Department's "concerning non-reaction" to unidentified objects entering US waters, and congressional legislation that defines UAP as trans-medium vehicles. It argues the engineering and physics involved could change almost every economic sector, and that the discoveries could make those of the 17th- and 18th-century Scientific Revolution "look like baby steps". It stresses how little attention the ocean receives compared with the sky, a gap the host finds starkest in AARO's [[AARO Historical Report Volume 1|Historical Report Volume 1]], which contains no USO cases or maritime whistleblowers.
...
### The Caribbean cruise-missile recovery

In a 2022 interview with astronaut Terry Virts, [[Luis Elizondo]] told a story from an unnamed source (see [[Caribbean Island Cruise Missile Recovery USO Encounter]]). A Navy helicopter regularly flew from a Caribbean island to recover test-fired cruise missiles, which sink after running out of fuel and later rise to be collected for telemetry. On one recovery, the crew saw something round, dark and "about the size of a small island" rise toward the surface without breaking it. A month later, as a frogman hung from a rope to latch onto another missile, the object rose again over the Puerto Rico Trench, some 22,000 feet deep. The frogman climbed the rope in an emergency ascent, the crew pulled away, and the object pulled the missile under and vanished.

### USS Carl Vinson, 2010

Petty Officer John Bowman said that off the coast of Haiti in 2010, looking down from the flight deck of the USS Carl Vinson, he saw a large, white, Tic Tac-shaped object about 20 feet long appear in the water, move right and dart into the depths; as it descended, its forward end "rapidly collapsed in on itself". His supervising officer did not debrief him, told him not to file a report, and said everybody sees weird things in the ocean. See [[USS Carl Vinson USO Sighting]].

### USS Nimitz, 1991

Thirteen years before the Tic Tac, the Nimitz had its own reported USO. Petty Officer Kevin Thomas said that, left on deck after the ship was ordered to darken and clear decks, he saw a "huge black triangle" nearly a kilometre long lift out of the ocean with no water dripping from it and no sound, then shoot vertically into the sky. The next day, men in civilian clothes questioned him aboard about why he was outside and what he saw; he said nothing, fearing discipline. The host says he could not find Thomas's service record. See [[USS Nimitz 1991 USO Encounter]].

## The USS Trepang Photographs
...
entries:
  ...
  - name: Edward J. Ruppelt
    role: Director of Project Grudge and Project Blue Book
    note: "His statement that AFOIN ran a fuller UFO investigation in parallel with Blue Book is the host's basis for reading AFOIN-X-SG as a secret special group."
  - name: Mark Dantonio
    role: Astronomer; president of FX Models
    note: "Says a submarine sonar team he rode with tracked a 'fast mover' at several hundred knots, and that a senior naval figure later confirmed a program to log USOs."
  - name: Oak Shannon
    role: Former Los Alamos special-projects manager; DOE nuclear physicist
  ...
  - name: John Greenewald
    role: Researcher, The Black Vault
    note: "Argues that the one altered USS Trepang image was likely enhanced for print and does not discredit the others."
---
::
...
- A 24 April 1952 letter from AFOIN-X-SG forwarded nine reports of submarine contacts with flying discs, compiled with the Office of Naval Intelligence; the host argues AFOIN's special group was a real secret UFO investigation body, and CUFON's 1979 FOIA requests about it were denied on national security grounds.
- Researcher Leonard Stringfield was told of thousands of ONI UAP reports filed between 1952 and 1956.
- USAF Regulation 200-2 (1953), OPNAV 3820 (23 January 1954) and JANAP 146c (1954) together removed military and maritime sightings from public view; JANAP 146c explicitly covered waterborne sightings and barred witnesses from discussing them under threat of prison and a $10,000 fine.
...
- Kevin Thomas claimed he saw a black triangle about a kilometre long rise silently from the ocean beside the USS Nimitz in 1991, and was questioned the next day by men in civilian clothes.
- The March 1971 USS Trepang photographs remain unresolved; the host considers the balloon-training explanation undercut by the witnesses' statements and the lack of records, leaving hoax or genuine, and agrees with John Greenewald that the one altered image does not discredit the rest.

## Sources

- [YouTube](https://www.youtube.com/watch?v=U-jrx_giINA) — UAP Gerb

## Related Pages

- **People**: [[Rear Admiral Timothy Gallaudet]], [[Luis Elizondo]], [[Oak Shannon]], [[David Fravor]], [[Mark Dantonio]], [[Dewey Fett]], [[John Ramirez]], [[Edward J. Ruppelt]], [[Leonard Stringfield]], [[Jacques Vallee]], [[Steven Greer]], [[Ross Coulthart]], [[John Greenewald]]
- **Organizations**: [[AFOIN Special Group (AFOIN-X-SG)]], [[Office of Naval Intelligence]], [[Office of Naval Research]], [[Project Blue Book]], [[Project Grudge]], [[Battelle Memorial Institute]], [[BDM International]], [[Los Alamos National Laboratory]], [[Sol Foundation]], [[National Oceanic and Atmospheric Administration (NOAA)]], [[AARO]], [[Disclosure Project]]
- **Locations**: [[Norton Air Force Base]], [[Shelburne Harbor, Nova Scotia]], [[Aguadilla, Puerto Rico]]
- **Concepts**: [[Unidentified Submerged Object (USO)]], [[Trans-Medium Vehicle]], [[JANAP 146c]], [[OPNAV 3820]], [[USAF Regulation 200-2]], [[Beneath the Surface (Gallaudet White Paper)]], [[AARO Historical Report Volume 1]], [[Wilson-Davis Memo]]
- **Operations**: [[Project Interloper]], [[Project Stork]]
- **Events**: [[2004 Nimitz UAP Encounter (Tic Tac)]], [[Aguadilla Puerto Rico Trans-Medium UAP Incident]], [[Shelburne Harbor USO Incident]], [[Caribbean Island Cruise Missile Recovery USO Encounter]], [[USS Carl Vinson USO Sighting]], [[USS Nimitz 1991 USO Encounter]], [[USS Trepang USO Photographs]]
