...
1. **Instantaneous acceleration** — Sudden changes in velocity far exceeding known aircraft capabilities
2. **Hypersonic velocity** — Movement at extreme speeds without sonic booms or visible propulsion
3. **Low observability** — Ability to avoid radar detection or visual observation
4. **Trans-medium travel** — Movement seamlessly between air, water, and space
5. **Anti-gravity/No visible propulsion** — Flight characteristics suggesting manipulation of gravity or propulsion systems beyond current human technology
