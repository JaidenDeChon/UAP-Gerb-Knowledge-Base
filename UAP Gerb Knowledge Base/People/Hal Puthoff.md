...
## Lockheed Martin Advanced Technology Center Research
...
## Comments on Kona Blue and Kingman

UAP Gerb credits Puthoff with indirect confirmation that materials involved in the attempted [[Kona Blue]] technology transfer may trace back to the alleged 1953 [[Kingman, Arizona]] UFO crash retrieval. When asked directly about a possible Kingman connection, Puthoff reportedly gave "a bit of a cheeky look and refused to comment further" — a non-denial UAP Gerb's host treats as increasing confidence in the theory that the Kona Blue materials originated from Kingman. Puthoff has also remarked more broadly that the Department of Homeland Security, in attempting to facilitate the Kona Blue transfer, ran into resistance from what he characterized as "legacy program gatekeepers."
