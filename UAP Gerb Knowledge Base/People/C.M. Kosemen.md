---
name: "C.M. Kosemen"
role: "Author, artist, and speculative biologist"
tags:
  - person
---
...
*All Tomorrows* follows the descendants of humanity from the near future to approximately one billion years in the future, depicting how terrestrial humans colonize space, are conquered and genetically altered by an alien civilization called the Qu, and subsequently diversify into hundreds of radically different post-human species adapted to various planetary environments over hundreds of millions of years. The book is notable for:

- Applying real evolutionary biology principles (convergent evolution, genetic drift, isolation, adaptive radiation) to speculative futurism.
...
Kosemen has collaborated with paleontologist Darren Naish on books reassessing the plausibility of cryptozoological creatures if they were to exist as real biological organisms (*Hunting Monsters*, 2016 with Naish and John Conway). He also co-authored *All Yesterdays* (2012) with Naish and John Conway, which challenged overly conservative conventions in paleoart.
