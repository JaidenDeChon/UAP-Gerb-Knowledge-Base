...
1. **[[Project Magnet]]** — A scientific investigation into UAP propulsion, directed by Smith.
2. **Project Second Story** — A strategic and policy-focused investigation to recommend government responses to the UFO phenomenon.
...
Canada's [[Five Eyes Nations|Five Eyes]] intelligence-sharing relationship with the United States meant that Canadian officials had access to some US UAP data, though the full extent of US crash retrieval and reverse engineering programs—as described by Sarbacher—remained compartmentalized even from close allies.
