---
name: "Project Redlight"
aliases: ["Project Red Light"]
tags:
  - operation
---

**Project Redlight** (also written "Project Red Light") is an alleged classified US program for flight-testing recovered non-human craft and reverse-engineered vehicles at [[Area 51]], using craft said to have been shipped from [[Edwards Air Force Base]]. It is known only from witness testimony. The earliest account comes from the files of researcher [[Leonard Stringfield]]; [[Edgar Fouche|Edgar Fouché]] later tied the name to [[EG&G]], and a secondhand source of [[Arnold House]] tied it to [[Northrop Grumman]]. UAP Gerb treats Redlight as a likely name for the joint Edwards and Area 51 test program he associates with witness Ed and the [[412th Test Wing]].

## The Stringfield letter (1980)

UAP Gerb traces the first mention of the project to Leonard Stringfield, author of the *Crash Retrieval Status Reports*, as relayed by researcher [[Michael Schratt]]. In a letter dated 5 April 1980, a correspondent identified as "Mr. DL" described a witness called "MH", whose identity Schratt chose not to disclose. MH said he did radio maintenance at the Nevada atomic proving grounds from 1961 to 1963, as well as top-secret radio work for the Air Force, and that he took part in a top-secret operation at Area 51 called Project Red Light.

According to MH:

- test flights were conducted on a recovered UFO shipped from Edwards Air Force Base
- the craft was not conventionally powered and stayed silent in operation
- security was so tight that program personnel were rotated every six months
- he heard rumors that a West Coast American defense contractor was having difficulty reverse-engineering many of the craft's components

## Edgar Fouché and EG&G
