...
[[Brad Sorenson]], in his December 3, 1990 interview with [[William B. Scott]], noted that the [[Alien Reproduction Vehicle (ARV)|ARV Flux Liner]] craft used a large capacitor plate array as a central structural component, which led [[Mark McCandlish]] to initially ask Sorenson whether the craft operated on the Biefeld-Brown effect. Sorenson clarified that while the Biefeld-Brown effect may have had "some sort of application," the actual propulsion energy source was Zero Point Energy drawn from quantum vacuum fluctuations. McCandlish's hypothesis was that the Biefeld-Brown effect and [[Electrogravitics]] represent an early human discovery of a physical principle that the ARV program later developed into a full gravity-manipulation propulsion architecture.
...
UAP Gerb's *UAP Reverse Engineering at Edwards Air Force Base* adds documentary threads: a 1988 technical report, submitted under contract with the Air Force's astronautics laboratory at Edwards, explored the Biefeld-Brown effect as a way of converting electrostatic energy into propulsion, and around the same year [[SAIC]] studied similar electric propulsion mechanisms for the base. The host sets these alongside [[Project Outgrowth]], a 1972 Rocket Propulsion Laboratory study of anti-gravity concepts, as part of Edwards's long interest in alternative propulsion.
